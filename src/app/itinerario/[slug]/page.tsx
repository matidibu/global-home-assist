...
import { itineraryPlaces, type ItineraryPlace } from "@/data/itineraryPlaces";
...
// ─── Activity photo (polaroid-style card, reused from the Bali page pattern) ──
...
function ExpandedDay({ day, places }: { day: { day: number; theme: string; activities: DestActivity[] }; places: ItineraryPlace[] }) {
  return (
    <div>
