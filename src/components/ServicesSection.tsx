...
const accommodationServices: ServiceCard[] = [
  {
    name: "Booking.com",
    description: "Hoteles, apartamentos y más",
    icon: "🏨",
    color: "#003580",
    bgColor: "#eff6ff",
    borderColor: "#bfdbfe",
  ...
  {
    name: "Airbnb",
    description: "Alojamientos únicos y locales",
    icon: "🏠",
    color: "#FF5A5F",
    bgColor: "#fff1f2",
    borderColor: "#fecdd3",
  ...
  {
    name: "Hostelworld",
    description: "Hostels y alojamiento económico",
    icon: "🛏️",
    color: "#FF6600",
    bgColor: "#fff7ed",
    borderColor: "#fed7aa",
...
const carServices: ServiceCard[] = [
  {
    name: "Rentalcars",
    description: "Comparador de autos en todo el mundo",
    icon: "🚗",
    color: "#0066cc",
    bgColor: "#eff6ff",
    borderColor: "#bfdbfe",
  ...
  {
    name: "DiscoverCars",
    description: "Las mejores tarifas de alquiler",
    icon: "🔑",
    color: "#1a7a4a",
    bgColor: "#f0fdf4",
    borderColor: "#bbf7d0",
  ...
  {
    name: "AutoEurope",
    description: "Especialistas en Europa y más",
    icon: "🗺️",
    color: "#7c3aed",
    bgColor: "#f5f3ff",
    borderColor: "#ddd6fe",
...
const activityServices: ServiceCard[] = [
  {
    name: "GetYourGuide",
    description: "Tours, actividades y experiencias",
    icon: "🎯",
    color: "#FF5500",
    bgColor: "#fff7ed",
    borderColor: "#fed7aa",
  ...
  {
    name: "Viator",
    description: "Experiencias y tours locales",
    icon: "🧭",
    color: "#1a237e",
    bgColor: "#eff6ff",
    borderColor: "#bfdbfe",
  ...
  {
    name: "Klook",
    description: "Actividades y atracciones en Asia",
    icon: "🎪",
    color: "#e63946",
    bgColor: "#fff1f2",
    borderColor: "#fecdd3",
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        ...
        <span style={{ fontWeight: 600, fontSize: "15px", color: card.color }}>
          {card.name}
        </span>
      </div>
      ...
      <span style={{ fontSize: "11px", color: card.color, fontWeight: 500, marginTop: "4px" }}>
        Ver ofertas →
      </span>
    </div>
  );
...
function Group({ title, icon, services }: {
  title: string;
  icon: string;
