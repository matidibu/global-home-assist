...
const activityServices: ServiceCard[] = [
  { name: "GetYourGuide", description: "Tours, actividades y experiencias", icon: "🎯", color: "#FF5500", bgColor: "#fff7ed", borderColor: "#fed7aa", url: "https://www.getyourguide.com" },
  { name: "Viator", description: "Experiencias y tours locales", icon: "🧭", color: "#1a237e", bgColor: "#eff6ff", borderColor: "#bfdbfe", url: "https://www.viator.com" },
