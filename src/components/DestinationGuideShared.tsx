...
const T: Record<string, Copy> = {
  ...
  de: {
    categoryLabels: { cultura: "Kultur", "gastronomía": "Gastronomie", naturaleza: "Natur", arte: "Kunst", historia: "Geschichte", shopping: "Shopping", aventura: "Abenteuer", relax: "Entspannung" },
    tourEntriesGyg: "🎯 Touren und Tickets — GetYourGuide",
    day: "Tag",
    activitiesCount: n => `${n} Aktivitäten`,
    backToGuides: "Zurück zu den Reiserouten",
    daysMore: n => `📋 ${n} weitere Tage — erweitern, um die Details zu sehen`,
    tipsTitle: city => `💡 Praktische Tipps für ${city}`,
    imaginedThereTitle: "Können Sie sich schon dort sehen?",
    imaginedThereSub: "Erstellen Sie Ihre personalisierte Version mit Ihren eigenen Tagen, Vorlieben und Ihrem Budget.",
    generateFor: city => `Für ${city} erstellen →`,
    customFitTitle: "Möchten Sie eine maßgeschneiderte Reiseroute?",
    customFitSub: "Passen Sie Tage, Reiseart, Budget und Interessen an — kostenlos, in Sekunden.",
    generateForShort: city => `Für ${city} erstellen`,
    toursTitle: city => `🎯 Touren und Erlebnisse in ${city}`,
    toursSub: "Tickets ohne Warteschlange, geführte Touren und einzigartige Erlebnisse.",
    seeTours: "Verfügbare Touren ansehen →",
    customItineraryTitle: "Möchten Sie eine maßgeschneiderte Reiseroute?",
    customItinerarySub: "Passen Sie Reiseziel, Tage, Reiseart, Budget und Interessen an — mit echten Fotos, einer interaktiven Karte und Flugsuche.",
    generateItineraryFor: city => `Erstellen Sie Ihre Reiseroute für ${city}`,
    generateItinerary: "Erstellen Sie kostenlos Ihre personalisierte Reiseroute",
    readGuide: "Guide lesen",
  },
  it: {
    categoryLabels: { cultura: "Cultura", "gastronomía": "Gastronomia", naturaleza: "Natura", arte: "Arte", historia: "Storia", shopping: "Shopping", aventura: "Avventura", relax: "Relax" },
    tourEntriesGyg: "🎯 Tour e biglietti — GetYourGuide",
    day: "Giorno",
    activitiesCount: n => `${n} attività`,
    backToGuides: "Torna agli itinerari",
    daysMore: n => `📋 altri ${n} giorni — espandi per vedere i dettagli`,
    tipsTitle: city => `💡 Consigli pratici per ${city}`,
    imaginedThereTitle: "Ti ci vedi già lì?",
    imaginedThereSub: "Genera la tua versione personalizzata con i tuoi giorni, gusti e budget.",
    generateFor: city => `Genera per ${city} →`,
    customFitTitle: "Vuoi un itinerario su misura per te?",
    customFitSub: "Personalizza giorni, tipo di viaggio, budget e interessi — gratis, in pochi secondi.",
    generateForShort: city => `Genera per ${city}`,
    toursTitle: city => `🎯 Tour ed esperienze a ${city}`,
    toursSub: "Biglietti salta-fila, tour guidati ed esperienze uniche.",
    seeTours: "Vedi i tour disponibili →",
    customItineraryTitle: "Vuoi un itinerario su misura?",
    customItinerarySub: "Personalizza destinazione, giorni, tipo di viaggio, budget e interessi — con foto reali, mappa interattiva e ricerca voli.",
    generateItineraryFor: city => `Genera il tuo itinerario per ${city}`,
    generateItinerary: "Genera gratis il tuo itinerario personalizzato",
    readGuide: "Leggi la guida",
  },
  pt: {
    categoryLabels: { cultura: "Cultura", "gastronomía": "Gastronomia", naturaleza: "Natureza", arte: "Arte", historia: "História", shopping: "Compras", aventura: "Aventura", relax: "Relaxamento" },
    tourEntriesGyg: "🎯 Tours e bilhetes — GetYourGuide",
    day: "Dia",
    activitiesCount: n => `${n} atividades`,
    backToGuides: "Voltar aos roteiros",
    daysMore: n => `📋 mais ${n} dias — expande para ver o detalhe`,
    tipsTitle: city => `💡 Dicas práticas para ${city}`,
    imaginedThereTitle: "Já te imaginas lá?",
    imaginedThereSub: "Gera a tua versão personalizada com os teus dias, gostos e orçamento.",
    generateFor: city => `Gerar para ${city} →`,
    customFitTitle: "Queres um itinerário feito à tua medida?",
    customFitSub: "Personaliza dias, tipo de viagem, orçamento e interesses — grátis, em segundos.",
    generateForShort: city => `Gerar para ${city}`,
    toursTitle: city => `🎯 Tours e experiências em ${city}`,
    toursSub: "Bilhetes sem fila, tours guiados e experiências únicas.",
    seeTours: "Ver tours disponíveis →",
    customItineraryTitle: "Queres um itinerário à tua medida?",
    customItinerarySub: "Personaliza destino, dias, tipo de viagem, orçamento e interesses — com fotos reais, mapa interativo e pesquisa de voos.",
    generateItineraryFor: city => `Gera o teu itinerário para ${city}`,
    generateItinerary: "Gera gratuitamente o teu itinerário personalizado",
    readGuide: "Ler guia",
  },
};
