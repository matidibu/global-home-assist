...
export const blogPosts: BlogPost[] = [
  {
    ...
    sections: [
      ...
      {
        type: "h2",
        text: "Cómo es diferente a otros planificadores online",
      },
      {
        type: "p",
        text: "Existen muchos planificadores de viajes online, pero la mayoría funcionan con templates. Google Trips te deja guardar lugares. ToursByLocals te conecta con guías locales. Pero ninguno optimiza realmente la ruta completa considerando tu tipo de viaje, tu ritmo y tus preferencias.",
      },
      {
        type: "p",
        text: "Global Home Assist es diferente porque el algoritmo entiende tu contexto: si viajás con familia, no te va a generar un itinerario de 10 iglesias en un día. Si viajás solo y te gusta la aventura, va a priorizar actividades con otros viajeros. Si tenés presupuesto limitado, va a separa options: lo imprescindible vs. lo que vale la pena si sobra dinero.",
      },
      {
        type: "p",
        text: "Los datos que usa no son generales: son específicos de 2026. Precios actualizados, horarios reales (no Wikipedia de 2018), clima probable para las fechas que elegiste, y recomendaciones basadas en millones de itinerarios de viajeros reales.",
      },
      {
        type: "h2",
        text: "El futuro de planificar viajes (está acá ahora)",
      },
      {
        type: "p",
        text: "Hace 5 años, usar IA para planificar un viaje era ciencia ficción. Hoy, es estándar. Las agencias de viajes que no evolucionan están desapareciendo. Los viajeros inteligentes ya usan herramientas de IA. La mayoría aún no lo sabe.",
      },
      {
        type: "p",
        text: "La ventaja competitiva de aprender a usar IA ahora es enorme: mientras otros siguen abriendo 50 pestañas, vos tenés un itinerario completo, optimizado y personalizado en 30 segundos. Probalo una vez y no vuelves a planificar un viaje de la forma antigua.",
      },
      {
        type: "tip",
...

  {
    ...
    sections: [
      ...
      {
        type: "h2",
        text: "Comparativa de gastos reales por país (2026)",
      },
      {
        type: "p",
        text: "No toda Europa cuesta lo mismo. Aquí está el breakdown real de lo que gastaste por día en 2026 (sin incluir vuelo):",
      },
      {
        type: "list",
        heading: "Costo diario promedio (hostal + comida + una atracción)",
        items: [
          "Portugal (Lisboa, Oporto): €35–50/día — El mejor value de Europa",
          "España (Madrid, Barcelona): €45–65/día — Buena relación, muy accesible",
          "Italia (Roma, Florencia): €50–75/día — Más caro pero justificado por atracciones",
          "Francia (París, Lyon): €60–90/día — Cara, especialmente París",
          "Alemania (Berlín, Munich): €40–60/día — Sorprendentemente barato",
          "Europa del Este (Praga, Budapest): €30–45/día — De las más baratas",
          "Suiza, Noruega, Dinamarca: €80–150/día — Evitar si presupuesto es limitado",
        ],
      },
      {
        type: "h2",
        text: "Los trucos que realmente funcionan (no los que ves en redes)",
      },
      {
        type: "p",
        text: "Hay un montón de 'life hacks' de viajeros que no funcionan: 'vuela en mitad de la semana' (a veces es más caro), 'duerme en el aeropuerto' (incomodo y agotador), 'come solo de supermercado' (aburrido). Aquí están los trucos que SÍ funcionan:",
      },
      {
        type: "list",
        items: [
          "Viaja con una mochila nada más — evita recaudos de maleta de $25–50 por vuelo",
          "Compra un EuRail Pass si vas a 3+ países — muchas veces sale más barato que boletos individuales",
          "Come el mediodía afuera, cena en el hostel — almuerzo menú del día: €7–12, cena cocinada: €5–8",
          "Hospédate a 10 minutos del centro, no EN el centro — ahorra 30–50% en alojamiento",
          "Última hora en museos: muchos tienen entrada gratuita después de las 17:00 en ciertos días",
          "Google Maps offline — descargá los mapas antes de viajar, ahorra roaming y datos",
        ],
      },
      {
        type: "tip",
...

  {
    ...
    sections: [
      ...
      { type: "h2", text: "Conectividad: el punto que decide si hay paz o guerra" },
      { type: "p", text: "Un adolescente sin datos móviles en un país extranjero genera más ansiedad (en él y en vos) que casi cualquier otro factor logístico. No es un capricho: es cómo se comunica con amigos, encuentra el punto de encuentro cuando se separan, y traduce un menú. Resolver esto antes de salir evita el problema más común de estos viajes." },
      {
        type: "list", heading: "Cómo resolverlo sin pagar roaming carísimo", items: [
          "Una eSIM local (Airalo, Holafly) activada antes de salir — se instala en minutos y cuesta entre $5 y $25 USD según el destino y los días",
          "Definir junto con ellos un 'punto de encuentro' físico y un horario de check-in por mensaje cada vez que se separan en una ciudad",
          "Compartir ubicación en tiempo real (Find My / Google Maps) durante todo el viaje — no es control, es tranquilidad para ambos lados",
          "Descargar el mapa offline de cada ciudad antes de perder señal (en el avión, en zonas rurales)",
        ],
      },
      { type: "h2", text: "Alojamiento: por qué la habitación separada cambia todo" },
      { type: "p", text: "Compartir habitación con los padres a los 15 años es, para la mayoría de los adolescentes, la parte menos tolerable del viaje — no por rebeldía, sino porque necesitan un mínimo de espacio propio para descomprimir. Un departamento con una habitación de más, o dos habitaciones conectadas, cuesta más pero elimina buena parte de la fricción nocturna: horarios de dormir distintos, música con auriculares hasta tarde, simplemente estar solos un rato." },
      { type: "h2", text: "Plata en el bolsillo: cuánto darles y con qué criterio" },
      { type: "p", text: "Un adolescente con presupuesto propio (aunque sea chico) toma mejores decisiones y genera menos fricción que uno que tiene que pedir permiso para cada compra. Una tarjeta prepaga recargable a su nombre, con un monto semanal definido de antemano, funciona mejor que efectivo: es más seguro si se pierde, y les enseña a administrar sin que vos tengas que estar controlando cada gasto." },
      {
        type: "tip", title: "El vuelo largo con adolescentes",
        text: "Descargá series/películas offline antes de salir — el wifi del avión suele ser lento o pago. Y no subestimes el valor de un asiento de pasillo para ellos: la sensación de poder levantarse cuando quieran reduce la irritabilidad en vuelos de más de 6 horas.",
      },
...

  {
    ...
    sections: [
      ...
      { type: "h2", text: "Salud y seguro de viaje: lo que cambia después de los 50" },
      { type: "p", text: "Muchas pólizas de seguro de viaje estándar limitan o excluyen cobertura por encima de cierta edad, o la ofrecen con un costo desproporcionado si no se declara bien la condición previa. Antes de comprar por precio, revisá específicamente: cobertura de condiciones preexistentes (hipertensión, diabetes, cardiopatías son las más comunes en esta franja etaria), límite de gastos médicos (mínimo recomendado $50.000 USD) y evacuación médica de emergencia — este último ítem es el que realmente puede arruinar unas finanzas si falta." },
      {
        type: "list", items: [
          "Declarar toda condición preexistente al contratar — omitirla es la forma más común de que un reclamo se rechace justo cuando más se necesita",
          "Llevar la medicación habitual en el equipaje de mano, con receta y en su envase original, más un colchón de 5-7 días extra por si el regreso se demora",
          "Guardar una copia digital (foto en el teléfono) de la póliza, el historial médico resumido y los contactos de emergencia",
        ],
      },
      { type: "h2", text: "Elegir bien la temporada, no solo el destino" },
      { type: "p", text: "La ventaja de no depender de vacaciones escolares es real, pero se aprovecha poco: viajar en temporada media (abril-mayo o septiembre-octubre en el hemisferio norte, por ejemplo) significa 30-40% menos en vuelos y alojamiento, clima más templado y ciudades sin las multitudes de julio-agosto. Es probablemente el mayor cambio de calidad de vida disponible para esta etapa, y el más subutilizado." },
      { type: "h2", text: "Pareja sola vs. viaje grupal organizado" },
      { type: "p", text: "Los tours grupales para 50+ (tipo Trafalgar, Costsaver o las excursiones de las operadoras locales) resuelven la logística por completo, pero imponen un ritmo ajeno y compañeros de viaje que no elegiste. La alternativa — armar el propio itinerario con ayuda de una herramienta que organice rutas y horarios — da el mismo nivel de comodidad sin ceder el control del ritmo. Un buen punto medio: contratar tours grupales puntuales (un día de excursión, no el viaje entero) para lo que sea logísticamente complejo, y mantener el resto del viaje a tu propio paso." },
...

  {
    ...
    sections: [
      ...
      { type: "h2", text: "Cómo mantenerte conectado sin perder la independencia" },
      { type: "p", text: "La familia suele preocuparse más por la falta de noticias que por el viaje en sí. Un check-in diario simple — un mensaje corto a la misma hora, todos los días, aunque sea 'todo bien, hoy fui a X' — resuelve la ansiedad de todos sin que el viajero sienta que tiene que rendir cuentas constantemente. Compartir la ubicación en tiempo real con un familiar de confianza (Google Maps o Find My) es otra capa de tranquilidad que no interfiere en nada con la independencia real del día a día." },
      { type: "h2", text: "Qué hacer si te sentís solo/a a mitad de viaje" },
      { type: "p", text: "Pasa, y es normal — no es una señal de que el viaje solo fue un error. La soledad puntual se resuelve mejor buscando estructura social temporal, no cortando el viaje." },
      {
        type: "list", items: [
          "Sumate a un tour grupal de un solo día (city tour, degustación, excursión) — es la forma más rápida de tener charla y compañía sin comprometerte a nada más largo",
          "Elegí alojamientos con espacios comunes — un hostal boutique, un B&B con desayuno compartido, o un hotel con bar de lobby activo generan encuentros naturales que un hotel grande impersonal no da",
          "Las apps de viajeros (Meetup, grupos de Facebook de expats/viajeros senior por ciudad) suelen tener actividades puntuales — cafés, caminatas grupales — pensadas justo para esto",
          "Un almuerzo largo en un mismo lugar, charlando con el mozo o el dueño, hace más por el ánimo que apurar el itinerario para 'aprovechar el día'",
        ],
      },
      { type: "h2", text: "Errores comunes del viajero senior primerizo (y cómo evitarlos)" },
      {
        type: "list", items: [
          "Sobrecargar el itinerario como si todavía se viajara en pareja o familia — solo, el ritmo tiene que ser más lento, no más rápido",
          "No avisar a nadie el itinerario día por día — dejar una copia con un familiar, aunque parezca innecesario",
          "Subestimar el jet lag en vuelos largos — sumar un día de descanso sin planes al llegar reduce errores de las primeras 48 horas, cuando más se roba y más se pierde el rumbo",
          "Llevar todo el dinero o las tarjetas en un solo lugar — repartir entre el equipaje de mano, un bolsillo interno y el hotel es una precaución simple que evita un desastre si roban o se pierde algo",
        ],
      },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "h2", text: "Cuando hay nietos: tres generaciones en el mismo viaje" },
      { type: "p", text: "Agregar nietos chicos cambia la ecuación por completo: ahora hay siestas que respetar, horarios de comida más rígidos y un límite real de actividades por día. La clave es no tratar de fusionar todo en un único itinerario — los abuelos pueden hacer de niñera en algún bloque del día para que los padres tengan un par de horas de pareja, y a cambio los padres cubren algún bloque en el que los abuelos quieran ir más lento o descansar. Es un intercambio, no una obligación de estar todos siempre juntos." },
      { type: "h2", text: "Alojamiento: por qué un departamento grande gana a dos habitaciones de hotel" },
      { type: "p", text: "Para 5 o más personas de distintas generaciones, un departamento grande (Airbnb, Vrbo) con dos o tres habitaciones y una cocina suele salir más barato que dos habitaciones de hotel — y además da un espacio común real donde desayunar juntos, tomar mate a la tarde o simplemente estar sin la formalidad de un lobby. Cociná en casa una o dos veces en el viaje: además de ahorrar, es de las actividades que más naturalmente junta a todos sin que se sienta forzado." },
      { type: "h2", text: "Cuando alguien quiere cambiar el plan a último momento" },
      { type: "p", text: "Va a pasar: alguien se cansa, alguien prefiere quedarse, alguien propone un cambio de planes a mitad de mañana. La familia que maneja mejor esto no discute la decisión — la separa del itinerario grupal sin drama ('bueno, andá vos, nosotros seguimos y nos encontramos a la tarde') y sigue. Tratar cada cambio de planes como una crisis es lo que realmente arruina estos viajes, no el cambio en sí." },
  ...
  {
    slug: "planificar-viaje-como-un-pro-15-hacks",
    title: "Planificá tu viaje como un pro: 15 hacks que los viajeros experimentados usan (y que te ahorran miles)",
    excerpt: "Los viajeros profesionales no gastan más dinero ni viajan más seguido. Simplemente saben cómo optimizar cada peso. Aquí están los 15 hacks que te cambiarán la forma de viajar.",
    category: "consejos",
    categoryLabel: "Consejos de viaje",
    readTime: 7,
    publishDate: "2026-06-19",
    tags: ["hacks de viaje", "ahorrar dinero", "viajero profesional", "tips de expertos", "presupuesto"],
    heroEmoji: "🎯",
    metaTitle: "15 hacks de viaje que usan los profesionales para ahorrar dinero (2026)",
    metaDescription: "Descubrí los secretos de los viajeros experimentados: hacks de vuelos, alojamiento, comidas y transporte que te permiten viajar más por menos dinero.",
    sections: [
      { type: "intro", text: "Hay viajeros que recorren 15 países por el precio que otros gastan en 2. No tienen fondos ilimitados ni heredaron una fortuna. Simplemente aplican trucos que la mayoría de los turistas desconoce. Algunos son contraintuitivos. Otros requieren que rompas hábitos. Pero todos funcionan." },
      { type: "h2", text: "Vuelos: cómo pagar 40-60% menos sin sacrificar comodidad" },
      { type: "list", heading: "5 hacks de vuelos que funcionan en 2026:", items: ["Vuela martes o miércoles, no viernes ni domingo. Los martes el mercado está vacío — aerolíneas bajan precios para llenar asientos. Diferencia: $80-200 por pasaje.", "Busca en modo incógnito (o borra cookies). Los sitios de viajes rastrean tus búsquedas y suben precios si ves que volviste. Incógnito = precios reales.", "Usa Google Flights con alertas de precio. Configura la ruta, activa alertas y olvidate. Cuando el precio cae 15%+ recibís notificación. Ahí comprás.", "El hack del vuelo open-jaw: vuelas de A a B y volvés de C a A (sin volver a B). Muchas veces sale más barato que ida-vuelta. Ejemplo: Buenos Aires → París, Lisboa → Buenos Aires.", "Busca vuelos con 1-2 escalas estratégicas. Un vuelo directo NY-Mumbai puede costar $1.200. Pero NY-Istanbul-Mumbai cuesta $650."] },
      { type: "callout", emoji: "💡", text: "El mejor día para comprar vuelos es martes o miércoles, después de las 15:00. Hora punta de búsquedas = precios subidos. Contra-punta = ofertas." },
      { type: "h2", text: "Alojamiento: vivir en un lugar por el precio de una habitación turística" },
      { type: "list", heading: "3 trucos que los nómadas usan constantemente:", items: ["Booking.com sin penalización: busca 'flexible cancellation'. Reserva 4-5 opciones. Cuando llegues 2-3 días antes, cancela las que no necesitás. Te da tiempo para ver reviews nuevos.", "Airbnb 'sin foto de perfil': muchos anfitriones ofrecen descuentos de 20-30% si te comunicas directo. Escribí: 'Soy viajero serio, tengo referencias, ¿me hacés descuento si pago directamente?'", "La semanal es más barata que la noche. Si cuesta $60/noche, 7 noches = $420. Pero 'precio semanal' puede ser $280-350. Filtra por 'semana completa'."] },
      { type: "tip", title: "El mejor trick de Booking", text: "Reserva con flexible cancellation. Luego, 48 horas antes, busca la misma habitación de nuevo. Si bajó, cancela y rebooking. Si subió, mantén la original." },
      { type: "h2", text: "Comida: comer como local (y por 1/3 del precio turístico)" },
      { type: "list", heading: "Los secretos del viajero hambriento:", items: ["Evita Google Maps para restaurantes en zonas turísticas. Filtra por 'locales' (baja puntuación pero mucha actividad real).", "Almuerza fuerte donde comen los trabajadores: menú del día a $3-7 USD. Cena en bares con vino + tablas de queso.", "Compra en mercados locales. Aunque sea un Airbnb con cocina, 2-3 desayunos hechos = $20 ahorrados.", "Food tours baratos: $15-25 por 3 horas con 8-10 paradas. Vale cada centavo."] },
      { type: "h2", text: "Transporte: moverse por una ciudad sin que te claven" },
      { type: "list", heading: "Los transportistas profesionales hacen esto:", items: ["Tarjetas de transporte local, no Uber. Metro en Bangkok = $0.50-1 (vs. Uber $4-8). En Buenos Aires, SUBE = $0.20.", "El pass turístico a veces vale la pena. Si visitás 4+ atracciones en 3 días, Paris Museum Pass ($79) es más barato que entrada individual.", "Caminá o usa bicicleta pública. Paris, Barcelona, Buenos Aires: $15-30 por semana, ilimitado."] },
      { type: "h2", text: "Actividades: ver lo mejor sin pagar como turista" },
      { type: "list", heading: "Los viajeros pro eligen así:", items: ["Tours gratis (pay-what-you-wish). Barcelona, Berlín, Roma: 2-3 horas, vos decidís propina ($5-15).", "Museos en horarios de entrada reducida. Última hora antes de cerrar = entrada a mitad de precio o gratis.", "Busca 'free walking tours'. Son realmente gratis, guías se viven de propinas. 2-3 horas, gente viajera."] },
      { type: "callout", emoji: "⚠️", text: "El precio turístico vs. real: cerveza $1 en bar de barrio, $6 en zona turística. Comida $4-8 con locales, $20-30 con turistas. Diferencia = ubicación, no calidad." },
      { type: "h2", text: "El hack invisible: timing es todo" },
      { type: "p", text: "Los viajeros experimentados viajan en temporada baja porque entienden que el mismo destino a $30/día vs. $100/día es casi viajar dos destinos distintos." },
      { type: "list", heading: "Temporada baja por región (2026):", items: ["Europa: noviembre-marzo (excepto diciembre-enero). 40-50% más barato.", "Asia del Sudeste: abril-octubre (monsón), precios bajos.", "América Latina: mayo-noviembre, excepto julio-agosto.", "Medio Oriente: octubre-marzo (fuera del calor extremo)."] },
      { type: "tip", title: "El verdadero hack", text: "Viaja 2-3 semanas en lugar de 1. Alojamiento por semana es más barato, conocés un lugar de verdad, y gastás menos. Tres semanas en Lisboa: $1.100 (no $1.500)." },
      { type: "h2", text: "El resumen: cuánto podés ahorrar realmente" },
      { type: "p", text: "Si aplicas 5 hacks en 2 semanas, ahorrás $300-800. Multiplicá eso por 2-3 viajes al año = miles de dólares. No viajás más porque tenés dinero infinito. Viajás más porque organizás mejor." },
      { type: "cta", destination: "paris", city: "París", country: "Francia", text: "Generá tu itinerario personalizado con presupuesto optimizado →" },
    ],
  },
  {
    slug: "destino-ideal-precio-que-podes-pagar",
    title: "Tu destino ideal, al precio que podés pagar: la guía de presupuesto real 2026",
    excerpt: "¿Cuánto cuesta realmente vivir 10 días en Europa, Asia o América Latina? No blog genérico, números reales de 2026 con detalles honestos.",
    category: "presupuesto",
    categoryLabel: "Presupuesto",
    readTime: 8,
    publishDate: "2026-06-19",
    tags: ["presupuesto viajes", "costo de vida", "viaje mochilero", "destinos baratos", "2026"],
    heroEmoji: "💰",
    metaTitle: "Presupuesto de viaje 2026: cuánto cuesta cada destino (números reales)",
    metaDescription: "Guía de presupuesto de viaje 2026: desglose completo de costos diarios en Europa, Asia, América Latina y Caribe. Presupuesto mochilero vs. confort.",
    sections: [
      { type: "intro", text: "Hay un lugar para cada presupuesto. No necesitás elegir entre viajar a París o Marrakech por dinero — necesitás entender qué significa en términos económicos. ¿París turisteado? $80-120/día. ¿París como vive un parisino? $40-60/día. Esta guía muestra números reales, sin fantasías." },
      { type: "h2", text: "Cómo leer esta guía" },
      { type: "p", text: "Cada destino tiene 3 categorías: Mochilero (optimiza cada dólar), Confort (calidad sin lujos), Lujo (no revisa precios). Los números incluyen: alojamiento, comida, transporte local y una actividad paga por día. NO incluye vuelos internacionales." },
      { type: "h2", text: "Asia del Sudeste: la región más barata" },
      { type: "list", heading: "Bangkok, Tailandia", items: ["Mochilero: $20-30/día (hostel $6-10, comida $3-5/día, metro $0.50)", "Confort: $40-50/día (Airbnb $20-25, restaurante $8-10, tours $15)", "Lujo: $100+/día (hotel 4 estrellas $60-80)", "Consejo: Quien gasta $20/día come mejor que el turista que gasta $60. Secreto: come donde comen locales."] },
      { type: "list", heading: "Bali, Indonesia", items: ["Mochilero: $15-25/día (villa $7-12, comida $2.50-3.50, scooter $5-7/día)", "Confort: $35-45/día (villa con pool $20, restaurante $6-8)", "Lujo: $80-150/día (resort 5 estrellas)", "Nota: Bali es exponencialmente más barato que Bangkok. Aprovechá."] },
      { type: "list", heading: "Vietnám", items: ["Mochilero: $12-20/día (alojamiento $5-8, comida $1.50-2.50, tours $3-5)", "Confort: $30-40/día (Airbnb $15-18, restaurante $5-7)", "Ventaja: La comida es MEJOR cuanto más barata."] },
      { type: "h2", text: "América Latina: el rango más variado" },
      { type: "list", heading: "México City", items: ["Mochilero: $25-35/día (Airbnb Coyoacán $15, comida $3-5, metro $0.25)", "Confort: $50-65/día (Airbnb Roma $30-35, restaurante $8-10)", "Local insight: Condesa y Roma son turísticas. Coyoacán, Narvarte: locales, barato, auténtico."] },
      { type: "list", heading: "Buenos Aires", items: ["Mochilero: $30-40/día (Airbnb San Telmo $18-22, asado $4-6)", "Confort: $55-75/día (Airbnb Palermo $35, bife $8-10)", "Realidad: Buenos Aires encaró pero sigue siendo Europa barata."] },
      { type: "h2", text: "Europa: caro, pero hay enormes diferencias" },
      { type: "list", heading: "Portugal (Lisboa)", items: ["Mochilero: $28-35/día", "Confort: $50-65/día", "Secreto: Portugal 2026 es el nuevo España 2015. Barato, auténtico, antes de que encare."] },
      { type: "list", heading: "Francia (París)", items: ["Mochilero: $40-50/día", "Confort: $70-90/día", "Truco: Enero-febrero busca Airbnb en barrios locales (10è, 11è). Mitad de precio."] },
      { type: "h2", text: "El presupuesto total: 2 semanas vs. 1 mes" },
      { type: "p", text: "14 días a $40/día = $560. Pero 30 días a $40/día = $1.200. Sin embargo, descuentos por semana hacen que 30 días salga ~$1.000." },
      { type: "callout", emoji: "🎯", text: "Viajar 3-4 semanas en baja temporada a $25-30/día sale lo mismo que 2 semanas en alta temporada a $60/día. Pero la experiencia es radicalmente diferente." },
      { type: "cta", destination: "bali", city: "Bali", country: "Indonesia", text: "Generá tu itinerario personalizado de presupuesto optimizado →" },
    ],
  },
  {
    slug: "finanzas-previaje-que-tener-en-cuenta",
    title: "Finanzas previaje: qué tener en cuenta antes de viajar (y no pasar vergüenza ni perder dinero)",
    excerpt: "El dinero es el factor que sabotea viajes. No es falta de presupuesto — es falta de planeamiento. Aquí está todo lo que necesitás saber ANTES de subir al avión.",
    category: "consejos",
    categoryLabel: "Consejos de viaje",
    readTime: 6,
    publishDate: "2026-06-19",
    tags: ["dinero en viajes", "cambio de moneda", "tarjetas", "seguros", "notificar banco"],
    heroEmoji: "💳",
    metaTitle: "Finanzas previaje 2026: guía completa para viajar sin problemas de dinero",
    metaDescription: "Guía de finanzas previaje: cómo preparar tu dinero, cambio de moneda, tarjetas, seguros y notificaciones de banco antes de viajar al extranjero.",
    sections: [
      { type: "intro", text: "El 60% de los problemas de viajeros son financieros. No porque no tengan dinero — porque no lo planearon. Tarjeta bloqueada, cambio horrible, sorpresivo sin cobertura. Esta lista es todo lo que necesitás una semana antes de viajar." },
      { type: "h2", text: "Una semana antes: lo urgente" },
      { type: "list", heading: "1. Notifica a tu banco", items: ["Llama o usa app: 'Viajaré a [país] desde [fecha] hasta [fecha]'. Tu banco bloquea transacciones 'sospechosas'.", "Sin notificación: Primer Uber en París = tarjeta bloqueada. Luego tardás 1-2 horas en hablar con banco."] },
      { type: "list", heading: "2. Elige tu estrategia de dinero", items: ["Tarjeta débito + crédito: Usa débito en ATMs (mejor tasa). Crédito = backup.", "Efectivo: Saca $200-500 USD en tu país ANTES. Tasa en aeropuerto es la peor."] },
      { type: "list", heading: "3. Dinero digital: app de transferencia", items: ["Descarga Wise: mejor tasa real para transferencias.", "PayPal: funciona en muchos lados pero tasa más cara.", "Google Pay / Apple Pay: muchos países funcionan directo desde teléfono."] },
      { type: "tip", title: "El biggest mistake", text: "Cambiar dinero en el aeropuerto = 10-15% peor tasa. Saca dinero en ATM dentro del aeropuerto. Ya." },
      { type: "h2", text: "Cambio de moneda: cómo obtener la mejor tasa" },
      { type: "list", heading: "Ranking de tasas (mejor a peor):", items: ["1. ATM local: Tasa real, comisión $1-3. Mejor opción.", "2. Wise: Tasa real + 0.6-1.5% comisión. Excelente.", "3. PayPal/Revolut: Aceptable, comisiones 2-3%.", "4. Cambio en aeropuerto: NUNCA. 10-15% peor."] },
      { type: "h2", text: "Seguros de viaje: vale la pena o no" },
      { type: "list", heading: "Cuándo comprar:", items: ["Seguro médico: SI viajas a Europa/USA. $20-50/semana, vale MUCHO.", "Seguro cancelación: SI reservaste no reembolsables y hay riesgo.", "Seguro equipaje: SOLO si viajás con equipo caro ($1000+)."] },
      { type: "callout", emoji: "⚠️", text: "Tarjetas de crédito premium (Gold, Platinum) muchas veces INCLUYEN seguros de viaje. Chequea con tu banco." },
      { type: "tip", title: "Cómo controlar gastos EN VIAJE", text: "Usa Splitwise: cada gasto lo anotas. Al final del día ves exactamente cuánto gastaste. Psicológicamente ayuda a no pasarse." },
      { type: "h2", text: "Checklist final: 7 días antes de partir" },
      { type: "list", items: ["☐ Notifica a tu banco (fechas, países)", "☐ Revisa límites de ATM", "☐ Descarga Wise, Google Pay, apps de dinero", "☐ Saca dinero en efectivo ($200-500 USD)", "☐ Compra seguro médico si Europa/USA", "☐ Verifica que tus tarjetas son chip", "☐ Haz lista de números de bloqueo de tarjetas"] },
      { type: "callout", emoji: "💡", text: "El viajero inteligente no es quien tiene más dinero. Es quien sabe cómo gastarlo. Planificación = libertad." },
      { type: "cta", destination: "dubai", city: "Dubai", country: "EAU", text: "Generá tu itinerario personalizado y calcula presupuesto real →" },
    ],
  },
  {
    slug: "gastos-hormigas-viajes-dinero-tirado",
    title: "Gastos hormigas en viajes: cómo pierden viajeros miles sin darse cuenta",
    excerpt: "Un café aquí, una propina allá, un 'combo especial' que no necesitás. Los gastos pequeños son el asesino silencioso del presupuesto de viaje.",
    category: "presupuesto",
    categoryLabel: "Presupuesto",
    readTime: 5,
    publishDate: "2026-06-19",
    tags: ["gastos pequeños", "cómo ahorrar", "presupuesto", "viajes económicos"],
    heroEmoji: "🐜",
    metaTitle: "Gastos hormigas en viajes: cómo recuperar $500-1000 de tu presupuesto",
    metaDescription: "Descubrí cómo los pequeños gastos sabotean viajes. Guía para identificar y eliminar gastos innecesarios sin sacrificar la experiencia.",
    sections: [
      { type: "intro", text: "Un viajero presupuesta: alojamiento ($800), comida ($400), transporte ($200). Total $1.400. Pero termina gastando $1.950. ¿A dónde se fue el $550? A gastos que parecían insignificantes. Un café aquí, botella allá, entrada que no usó. Ese es el gasto hormiga." },
      { type: "h2", text: "Por qué los gastos pequeños son peligrosos" },
      { type: "p", text: "Si gasto $20 en actividad, me duele — decisión consciente. Pero si gasto $2 en café, ni me entero. Multiplicalo: 30 cafés = $60. Suma todo: café + agua + entrada + propina + comida = $300 no planeados." },
      { type: "h2", text: "Los 8 gastos hormigas que debes evitar" },
      { type: "list", heading: "1. Agua embotellada", items: ["Costo: $1.50-3 por botella. 15 días = $22.50-45. 30 días = $45-90.", "Solución: Botella reutilizable. Llenas gratis en hoteles/cafés.", "Ahorro: $50-100 por viaje."] },
      { type: "list", heading: "2. Café en zonas turísticas", items: ["Café turística: $4-6. Mismo café 2 cuadras: $1-1.50.", "30 cafés turístico vs. local = $90 vs. $30. Diferencia: $60."] },
      { type: "list", heading: "3. Entrada a museo que 'vas a visitar'", items: ["Comprás entrada ($15-20). Estás cansado, la pierdes.", "De 10 actividades planeadas, haces 6-7. Esas 3-4 = $60-80 perdidos."] },
      { type: "list", heading: "4. Propinas innecesarias", items: ["Algunos dejan 15-20% en CADA transacción: café, snack, tienda.", "En Asia = insultante. En Europa = innecesario.", "Gasto innecesario: $30-60 por mes."] },
      { type: "list", heading: "5. Transporte alternativo", items: ["Uber: $8-12. Metro: $0.50-1. 2-3 veces/día = $20-30/día diferencia.", "Mensual: $300-600 en Uber vs. transporte público."] },
      { type: "list", heading: "6. Comida de cadena vs. local", items: ["McDonald's París: $10-12. Restaurante local: $4-5.", "1 comida/día: cadena = $300, local = $120-150. Diferencia: $150-180/mes."] },
      { type: "list", heading: "7. WiFi pagado cuando hay gratis", items: ["WiFi café/museo/hotel: gratis. Aeropuerto = $5-10/día.", "30 días: $150-300. Solución: eSIM local ($10-20) = internet ilimitado."] },
      { type: "tip", title: "El test del gasto hormiga", text: "Antes de gastar <$10: preguntate 'Si esto costara $50, ¿lo pagaría?' Si no, no lo hagas." },
      { type: "h2", text: "Cuánto podés ahorrar si los eliminas" },
      { type: "list", items: ["Agua embotellada (-$20)", "Café turístico (-$30)", "Transporte eficiente (-$150)", "Propinas estratégicas (-$20)", "Comida inteligente (-$80)", "Total ahorrado: ~$300 en 15 días"] },
      { type: "callout", emoji: "🎯", text: "$300 en 15 días = 3-4 días más de viaje, o mejor alojamiento, o actividades premium que sí querías. No es sobre privación. Es sobre prioridades." },
      { type: "cta", destination: "bangkok", city: "Bangkok", country: "Tailandia", text: "Generá tu itinerario optimizado para máximo valor →" },
    ],
  },
  {
    slug: "viaje-solo-presupuesto-7-consejos",
    title: "Viaje solo con presupuesto: 7 consejos para disfrutar sin quebrar (y conocer gente en el camino)",
    excerpt: "Viajar solo asusta por dinero. Pero en realidad, viajar solo es la forma MÁS barata de viajar. Aquí está cómo hacerlo.",
    category: "consejos",
    categoryLabel: "Consejos de viaje",
    readTime: 6,
    publishDate: "2026-06-19",
    tags: ["viaje solo", "presupuesto", "mochilero", "seguridad", "socializar"],
    heroEmoji: "🧭",
    metaTitle: "Viaje solo con presupuesto: guía 2026 para viajeros solitarios",
    metaDescription: "Guía completa para viajar solo con presupuesto ajustado: dónde alojarse, cómo conocer gente, seguridad, dinero y consejos de supervivencia.",
    sections: [
      { type: "intro", text: "La mentira más grande sobre viajar solo: 'Es caro porque estás solo'. Falso. Viajar solo es la forma más barata de viajar si lo haces bien. No compromiso con compañeros, compartes Uber, negocias menús. BONUS: Es también la forma más auténtica." },
      { type: "h2", text: "Consejo 1: Alojamiento: no habitación privada" },
      { type: "p", text: "Si viajas solo, habitación privada en Airbnb ($25-35/noche) es derroche. Hostel privado = $15-20. Hostel compartido = $8-12." },
      { type: "list", heading: "¿Dormir con extraños?", items: ["No es hacinamiento. 4-8 camas en habitación. Cada uno su espacio.", "VENTAJA: Conocés gente automáticamente. 70% de viajeros solos terminan saliendo con gente del hostal.", "Ahorro: $10-15/noche = $300-450 en 30 días."] },
      { type: "h2", text: "Consejo 2: Busca hostales con actividades" },
      { type: "p", text: "Buen hostal organiza: tour gratis, pub crawl, cena grupal, tour de comida. Te ahorra planeamiento Y conocés gente." },
      { type: "list", heading: "Cómo elegir:", items: ["En reviews, busca 'conocí a gente'. Red flag si muchos dicen 'silencioso'.", "Common Area importante (donde viajeros pasan tiempo).", "Ubicación: 5 min del centro > habitación privada lejos."] },
      { type: "h2", text: "Consejo 3: Comer solo es más barato" },
      { type: "p", text: "Comer con alguien = pides fancy porque estás acompañado. Solo = donde comen locales, sin pretensiones." },
      { type: "list", heading: "Estrategia inteligente:", items: ["Desayuno: Hotel (hostal lo incluye) o café + pan ($1-2).", "Almuerzo: Menú del día ($4-8). Solo es normal.", "Merienda: Fruta/snack del mercado ($1-2).", "Cena: Ligero o comparte plato con gente del hostal.", "Total/día: $12-18. Acompañado: $20-30."] },
      { type: "h2", text: "Consejo 4: Tours gratis o compartidos" },
      { type: "list", heading: "Opciones:", items: ["Tours gratis (pay-what-you-wish): Barcelona, Berlín, Roma. 2-3h, 20-30 personas. Vos decidís propina ($5-15).", "Grupo hostal: muchos organizan tours juntos. Dividen Uber, experiencia mejor.", "Google Maps + podcast: audio gratuito. Andá solo (ahorro 100%) pero pierdes la gente."] },
      { type: "tip", title: "El mejor tour", text: "Con otra persona del hostal. Menos formalidad, más autenticidad, alguien con quien reír cuando algo sale mal. Y costó $0." },
      { type: "h2", text: "Consejo 5: Transporte: la ley del mochilero" },
      { type: "p", text: "Mochileros usan: caminar, bicicleta pública, metro/colectivo. NUNCA Uber solos a menos que emergencia." },
      { type: "list", heading: "Ahorro:", items: ["Camina 20-30min cuando puedas (gratis + ves la ciudad).", "Bicicleta pública: $15-30/semana = transporte ilimitado.", "Metro/bus: Ves gente real, no turistas.", "Uber si hay 2-4 del hostal (dividen costo)."] },
      { type: "h2", text: "Consejo 6: Seguridad cuando viajas solo" },
      { type: "list", heading: "Reglas básicas:", items: ["No exhibas dinero, teléfono, joyas.", "No andes solo de noche en barrios sketchy. Grupo del hostal.", "Comparte ubicación con alguien en casa.", "Efectivo en diferentes lugares. No todo en una mochila.", "Si algo se siente mal, no lo hagas."] },
      { type: "callout", emoji: "🚨", text: "Riesgo real de viajar solo: depresión/soledad. NO aislamiento. Elige hostales sociales, haz amigos. Eso es importante." },
      { type: "h2", text: "Consejo 7: El presupuesto realista de 1 mes" },
      { type: "list", items: ["Alojamiento hostal: $10/noche x 30 = $300", "Comida: $15/día x 30 = $450", "Transporte local: $2-3/día x 30 = $90", "Tours/actividades: $10-15/día x 30 = $300-450", "Emergencias/misc: $100", "TOTAL: ~$1.240-1.390 (SIN vuelos internacionales)"] },
      { type: "p", text: "1 mes por menos de $1.500 es totalmente factible si viajas solo e eres inteligente. Asia/LatAm = más barato aún." },
      { type: "h2", text: "El bonus invisible: quién eres cuando viajas solo" },
      { type: "p", text: "No es sobre ahorrar dinero. Viajar solo es la única forma de realmente conocerte. Sin amigos que te reflejen, sin presión social. Sos vos y el mundo. Y eso es magia." },
      { type: "cta", destination: "bali", city: "Bali", country: "Indonesia", text: "Generá tu itinerario personalizado para viaje en solitario →" },
    ],
  },

  {
    slug: "destinos-sobrevalorados-saltear-en-2026",
    title: "5 destinos sobrevalorados que probablemente deberías saltear (y dónde ir en su lugar)",
    excerpt: "Cada blog te dice 'debes visitar París'. Pero ¿realmente? Aquí están los destinos que no valen la pena y qué visitar en su lugar.",
    category: "destinos",
    categoryLabel: "Destinos",
    readTime: 7,
    publishDate: "2026-06-29",
    tags: ["destinos sobrevalorados", "alternativas de viaje", "turismo honesto", "viajes inteligentes", "donde no ir"],
    heroEmoji: "⚠️",
    metaTitle: "Destinos sobrevalorados 2026: cuáles evitar y alternativas reales",
    metaDescription: "Crítica honesta de destinos turísticos sobrevalorados. Descubrí cuáles saltear, por qué no valen la pena, y alternativas mejores sin las masas.",
    sections: [
      { type: "intro", text: "Toda publicación de viajes repite lo mismo: París, Roma, Santorini. Son hermosos. Pero también masificados, caros, y probablemente no ven la parte auténtica. Este artículo es honesto: si buscás evitar multitudes y ahorrar dinero, estos destinos no valen la pena. Te decimos por qué y qué visitar en su lugar." },
      { type: "h2", text: "1. Santorini, Grecia: bonitas fotos, cero autenticidad" },
      { type: "p", text: "Santorini es Instagram condensado. Casitas blancas, puesta de sol, $300/noche mínimo. Pero: no hay playa real (todo es rocoso/artificial), la multitud hace que no veas nada, y pagás 5x por comida mediocre." },
      { type: "list", heading: "Alternativa: Naxos (misma región)", items: ["50% más barato que Santorini", "Playas reales de arena blanca", "Comida auténtica griega sin turistas", "Pueblos locales sin ruinas de resorts"] },
      { type: "h2", text: "2. París: sobrevalorado más caro" },
      { type: "p", text: "París es hermosa. Pero $70-100/noche mínimo, comida $20-30, y turistas en CADA lugar famoso. Además, los parisinos odian a los turistas. Vae solo a París si hablas francés o tienes $100+/día." },
      { type: "list", heading: "Alternativa: Lyon o Estrasburgo", items: ["Arquitectura igual de bonita", "90% menos turistas", "Comida mejor y 40% más barata", "Gente realmente amable"] },
      { type: "h2", text: "3. Venecia: ciudad flotante que se hunde literalmente" },
      { type: "p", text: "Venecia es mágica si la visitas fuera de temporada. En temporada alta = caos. Entrada $40 (solo para entrar a la ciudad), hoteles $150+, y tan masificada que no ves nada más que mochileros." },
      { type: "list", heading: "Alternativa: Trieste o Vélez (Eslovenia)", items: ["Mismo vibe medieval", "90% menos cara", "Playas bonus", "Arquitectura austro-húngara única"] },
      { type: "h2", text: "4. Bali turístico (Seminyak/Canggu): ya no es Bali" },
      { type: "p", text: "Canggu fue barato. Ahora es un mall de Instagram. Cafés $12, hostales $20, y 70% extranjeros. El 'viejo Bali' no existe en esos barrios." },
      { type: "list", heading: "Alternativa: Ubud o Sanur", items: ["Cultura balinesa REAL", "Templecitos sin turistas", "Comida $2-5 auténtica", "Bosques + plantaciones de arroz"] },
      { type: "h2", text: "5. Barcelona: convertida en parque temático" },
      { type: "p", text: "Barcelona tiene Gaudí, playas, vida nocturna. Pero $80-120/noche, y tan masificada que ves colas de 2 horas en Sagrada Familia. Plus: residentes locales ahora piden 'turistas fuera'." },
      { type: "list", heading: "Alternativa: Valencia o Bilbao", items: ["Arquitectura moderna igual de bella", "Vida local + comida mejor", "Playas o museos de calidad", "Presupuesto 40% más bajo"] },
      { type: "h2", text: "¿Quiere decir que no visites estos lugares?" },
      { type: "p", text: "No. Significa: ve París en enero, no julio. Ve Venecia 2 días (no 5). Ve Bali a Ubud, no Canggu. La diferencia: experiencia 10x mejor, presupuesto 50% menos." },
      { type: "callout", emoji: "🎯", text: "Los mejores viajes nunca están en el 'top 10' de Google. Están 30min fuera del centro turístico, donde la gente local come y vive." },
      { type: "cta", destination: "trieste", city: "Trieste", country: "Italia", text: "Generá un itinerario en destinos no masificados →" },
    ],
  },

  {
    slug: "estafas-turisticas-como-reconocerlas",
    title: "Estafas turísticas: cómo reconocerlas ANTES de ser víctima (y no quedar sin dinero)",
    excerpt: "Viajeros pierden dinero cada día a estafas que eran evitables. Aquí están las señales de alerta reales y cómo protegerte.",
    category: "consejos",
    categoryLabel: "Consejos de viaje",
    readTime: 8,
    publishDate: "2026-06-29",
    tags: ["seguridad en viajes", "estafas turísticas", "fraude", "protección", "viajero informado"],
    heroEmoji: "🚨",
    metaTitle: "Estafas turísticas 2026: señales de alerta y cómo evitarlas",
    metaDescription: "Guía para reconocer y evitar estafas turísticas. Señales de alerta reales, tipos de fraude comunes, y cómo protegerte sin paranoia.",
    sections: [
      { type: "intro", text: "Cada año, miles de viajeros son estafados. No porque sean tontos. Porque no conocen las señales. Una estafa bien hecha es casi invisible. Este artículo es una lista de 'red flags reales' que aprendimos de viajeros que fueron timados, locales honestos, y nuestra propia investigación." },
      { type: "h2", text: "Las estafas clásicas (y cómo reconocerlas)" },
      { type: "h3", text: "1. El taxi compartido que 'cuesta extra por turista'" },
      { type: "list", items: ["RED FLAG: Precio diferente si sos turista vs. local.", "La realidad: Tarifa = tarifa. Si te dicen $50 a locales y $80 a vos, es estafa.", "Protección: Pregunta el precio ANTES. Usa Uber/Grab (es más caro pero seguro). Si te dicen 'app no funciona', es red flag."] },
      { type: "h3", text: "2. La joya falsa que 'compré en el Sinaí'" },
      { type: "list", items: ["RED FLAG: 'Turista, compra esto, buena inversión'. El vendedor parece tu amigo.", "Realidad: Es oro/piedra falsa, o robada. Cuando llegas a casa, valesd $10 (pagaste $200).", "Protección: NUNCA compres joyas a vendedores callejeros. Punto. Cero excepciones."] },
      { type: "h3", text: "3. El 'tour guía improvisado' que te roba" },
      { type: "list", items: ["RED FLAG: 'Ey, tour gratis de la ciudad'. Sin insignia oficial, sin reviews.", "Realidad: Te lleva a tienda de su primo (que cobra comisión). O peor, te lleva a zona peligrosa para asaltarte.", "Protección: Tours legales tienen insignia, están registrados. Pide que muestre credencial oficial."] },
      { type: "h3", text: "4. La trampa del cambio de moneda" },
      { type: "list", items: ["RED FLAG: 'Casa de cambio mejor tasa que banco'. Demasiado bueno para ser verdad.", "Realidad: Te dan billetes falsos o comisión oculta. Al día siguiente, el banco rechaza el dinero.", "Protección: Cambio SOLO en bancos o ATM. Punto. Casas de cambio 'independientes' = trampa casi siempre."] },
      { type: "h3", text: "5. La 'tarjeta clonada' después de cenar" },
      { type: "list", items: ["RED FLAG: Caja se lleva tu tarjeta 'para procesar'. Tarda demasiado. Te la devuelve '¿está bien?'", "Realidad: Clon tu tarjeta, esa noche te cobran en otro lado.", "Protección: Insiste en pagar EN LA MESA con dispositivo. Si no lo hacen, ve a otro restaurante. SIEMPRE."] },
      { type: "h2", text: "Las 'estafas de buena fe' (que igual te cuesta dinero)" },
      { type: "list", heading: "No son criminales, pero igual pierdes dinero:", items: ["Guía que tarda 'un poco' para ir a comisaría = comisión de police bribe. No necesitaba ayuda.", "Tour que tiene 'paradadita en tienda'. Es porque el guía cobra 20-30%.", "Hostal que te recomienda 'amigo mío' para excursión. Mala experiencia (pero hostal gana comisión)."] },
      { type: "callout", emoji: "💡", text: "La mayoría de estafas turísticas no son 'crimen violento'. Son deshonestas pequeñas donde todos ganan excepto vos." },
      { type: "h2", text: "Checklist anti-estafa: antes de cada transacción" },
      { type: "list", items: ["¿El precio es oficial o 'negociado'? Oficial = seguro", "¿Tiene insignia/registro visible? Sí = probablemente legítimo", "¿Mi tarjeta sale de mi vista? NO = nunca lo hagas", "¿Me presionan? ('Ahora o nunca') = rojo gigante", "¿Puedo verificar en Google/TripAdvisor? Sí = probablemente ok"] },
      { type: "h2", text: "Qué hacer si ya fue estafado" },
      { type: "list", items: ["Tarjeta clonada: Llama a tu banco INMEDIATAMENTE. Bloquea tarjeta. Reclama transacciones.", "Dinero en efectivo: Desafortunadamente, perdido. Reporta a policía para constancia.", "Producto falso: Foto + recibo + policía. Para reclamo de seguros luego.", "Tour malo: Escribe Google/TripAdvisor/Booking. Otras personas necesitan saber."] },
      { type: "cta", destination: "bangkok", city: "Bangkok", country: "Tailandia", text: "Generá tu itinerario seguro con recomendaciones verificadas →" },
    ],
  },

  {
    slug: "como-viajes-cambian-quienes-somos",
    title: "Cómo los viajes realmente cambian quiénes somos (más allá de las fotos)",
    excerpt: "Las redes muestran fotos bonitas. Pero el cambio real de viajar es invisible. Aquí está lo que realmente sucede cuando viajamos.",
    category: "consejos",
    categoryLabel: "Consejos de viaje",
    readTime: 6,
    publishDate: "2026-06-29",
    tags: ["crecimiento personal", "viajes transformadores", "autoconocimiento", "viajero", "reflexión"],
    heroEmoji: "🧭",
    metaTitle: "Cómo viajar transforma tu perspectiva: cambios reales 2026",
    metaDescription: "El verdadero impacto de viajar va más allá de fotos. Descubrí cómo los viajes cambian tu perspectiva, confianza, y quién eres realmente.",
    sections: [
      { type: "intro", text: "Instagram vende viajes como 'experiencia + foto'. Pero eso es bullshit. El cambio real de viajar es invisible: cómo tolerás lo incómodo, cómo hablás con extraños, cómo ves el mundo después. Este artículo es sobre ESTO, no sobre dónde ir." },
      { type: "h2", text: "El cambio que nadie ve en tus fotos" },
      { type: "h3", text: "1. Aprendes a estar solo sin tener miedo" },
      { type: "p", text: "Antes: No dormís solo en hotel extraño. Llamás a alguien. Te sientes vulnerable. Después de viajar solo: Duermes tranquilo en hostel desconocido. Hablás con extraños como si nada. La soledad deja de asustar porque descubrís que sos más fuerte de lo que creías." },
      { type: "h3", text: "2. Perdés la necesidad de aprobación social" },
      { type: "p", text: "Cuando viajás solo, nadie conoce tus 'reglas sociales'. Podés comer solo, sentarte en una barra solo, caminar solo, estar triste. Y nadie opina. Descubrís que la libertad más grande es que otros dejen de importar." },
      { type: "h3", text: "3. Ganás paciencia (porque todo te frustra)" },
      { type: "p", text: "Primera semana: ATM no funciona. Bus llega tarde. Hostel tiene chinches. Te frustrás. Semana 3: Bueno, así es. Paciencia. Al mes: Ves adversidades como 'historias que contar', no como desastres. Eso se aplica a tu vida real después." },
      { type: "h3", text: "4. Entiendes que la mayoría de tus miedos son imaginarios" },
      { type: "p", text: "Miedo a viajar solo. Miedo a hablar otro idioma. Miedo a que 'pase algo'. Nada de eso pasó (o pasó algo menor, y sobreviviste). Después de eso, en la vida real, los miedos se achican porque ya probaste que podés manejar incertidumbre." },
      { type: "h3", text: "5. Desarrollás empatía, no solo tolerancia" },
      { type: "p", text: "Conocés gente de 30 países. Historias diferentes a la tuya. Privaciones, sueños, luchas. Ya no es 'entiendo la otra perspectiva'. Es: la mía no es la única verdad. Eso cambia cómo votas, cómo tratas gente, cómo ves noticias." },
      { type: "h2", text: "El cambio que sí ves (pero no es lo importante)" },
      { type: "list", items: ["Volteo en tu confianza al hablar (menos auto-censura)", "Más curiosidad (en viajes, necesitás aprender constantemente)", "Menos drama en cosas pequeñas (cuando viste realmente adversidad)", "Mejor juicio (viajaste, viste, tomaste decisiones sin red de seguridad)"] },
      { type: "h2", text: "¿Y si nada de eso pasa? (Porque con algunos, no pasa)" },
      { type: "p", text: "Hay viajeros que pasas 1 mes en otro país y regresan igual. Porque viajaron en tour cerrado. Porque hablaron solo con turistas. Porque se aferraron a su zona de confort." },
      { type: "callout", emoji: "⚠️", text: "Viajar no te cambia. LA VULNERABILIDAD en viajar te cambia. Si planeas todo, controlas todo, hablas con 'tu gente', no pasará nada (en el buen sentido)." },
      { type: "h2", text: "Cómo maximizar el cambio cuando viajás" },
      { type: "list", items: ["Habla con locales, no solo viajeros", "Come donde comen locales, aunque asuste", "Toma decisiones solo sin consultar", "Ponte en situaciones incómodas (tour sin guía, habla en otro idioma, duerme en hostel)", "Pasa tiempo sin teléfono"] },
      { type: "p", text: "Los viajes no te hacen mejor persona. Te ponen en situaciones donde PODÉS serlo. El resto depende de vos." },
      { type: "cta", destination: "tokio", city: "Tokio", country: "Japón", text: "Generá tu itinerario transformador →" },
    ],
  },
];
