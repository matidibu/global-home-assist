...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "bangkok-guia-viajero-2026",
    title: "Bangkok en 2026: la guía honesta que nadie te da antes de ir",
    excerpt: "Bangkok es caótica, húmeda y absolutamente fascinante. Pero los consejos genéricos de internet te van a llevar a las zonas turísticas más caras y menos auténticas. Esta guía es distinta.",
    category: "guias",
    categoryLabel: "Guías de viaje",
    readTime: 7,
    publishDate: "2026-01-15",
    tags: ["Bangkok", "Tailandia", "sudeste asiático", "templos Bangkok", "comida callejera Bangkok"],
    heroEmoji: "🛕",
    metaTitle: "Bangkok 2026: guía de viaje completa, templos, comida y consejos reales",
    metaDescription: "Guía honesta de Bangkok: cómo moverse, los mejores templos, dónde comer comida callejera auténtica, y qué hacer para no caer en las trampas turísticas más comunes.",
    sections: [
      { type: "intro", text: "Bangkok es una ciudad que polariza: la amás o la odiás desde el primer día. El calor de 35°C con 90% de humedad, el tráfico que no existe en occidente y el ruido constante pueden agobiar. Pero si le das una oportunidad de 48 horas, revela una cultura gastronómica, arquitectónica y humana que pocas ciudades del mundo pueden igualar." },
      { type: "h2", text: "Cuándo ir a Bangkok" },
      { type: "p", text: "La temporada alta es noviembre a febrero: 28-32°C, baja humedad y sin lluvia. La temporada de monzones (junio-octubre) no impide el turismo pero sum lluvias intensas por la tarde. Evitá abril (Songkran, el año nuevo tailandés) a menos que quieras participar en la guerra de agua más grande del mundo — es una experiencia única pero los hoteles triplican precios." },
      { type: "h2", text: "Cómo moverse: la clave del presupuesto" },
      { type: "list", items: [
        "BTS Skytrain y MRT Metro: rápidos, con aire acondicionado, $0.50-1 USD por viaje. El transporte más eficiente de la ciudad.",
        "Tuk-tuk: icónico pero caro. Negociá siempre el precio ANTES de subir. Si te ofrecen llevarte a un templo 'gratis' es una trampa de comisión de tiendas.",
        "Mototaxis (motocicleta naranja): los más rápidos para distancias cortas. Usá las apps Grab o Bolt para precio fijo sin negociación.",
        "Barco en el río Chao Phraya: el transporte más fotogénico y funcional. Línea naranja $0.30, línea expreso turística $2.",
        "Taxi con contador: pedí siempre que pongan el taxímetro. Si se niegan, bajá y tomá otro.",
      ]},
      { type: "h2", text: "Los templos que realmente vale la pena visitar" },
      { type: "p", text: "Bangkok tiene cientos de wat (templos budistas). Estos son los que justifican el viaje:" },
      { type: "list", items: [
        "Wat Pho: el Buda reclinado de 46 metros. Entrada 200 baht. Mejor templo de Bangkok y sede de la escuela de masaje tailandés más antigua.",
        "Wat Arun (Templo del Amanecer): cruzá el río en ferry desde Wat Pho por 5 baht. Impresionante al atardecer. Entrada 100 baht.",
        "Wat Phra Kaew (Buda Esmeralda): dentro del Grand Palace. Entrada 500 baht, incluye ambos. Código de vestimenta estricto — cubrí hombros y rodillas.",
        "Wat Suthat: el templo más infravisitado y más impresionante artísticamente. Sin colas, entrada 20 baht.",
        "Wat Saket (Montaña Dorada): 318 escalones al tope. Vista panorámica de Bangkok sin costo de entrada.",
      ]},
      { type: "h2", text: "Dónde comer: la clave es la calle" },
      { type: "p", text: "Bangkok tiene la mejor comida callejera del mundo — y lo dicen los chefs con estrellas Michelin. El error de los turistas es comer en restaurantes con menú en inglés y foto en la puerta: son caros y mediocres." },
      { type: "list", items: [
        "Yaowarat (Chinatown): el epicentro gastronómico. Los viernes y sábados de noche es la mejor experiencia callejera de Asia. Pad see ew, dim sum y mariscos desde $1.",
        "Mercado de Or Tor Kor: el mercado de alimentos más limpio y de mayor calidad de Bangkok. Para probar frutas tropicales exóticas.",
        "Jay Fai: la única comida callejera con estrella Michelin del mundo. Reservá con semanas de anticipación, cuesta $15-30 el plato, pero es experiencia de vida.",
        "Boat Noodles en el canal: fideos de barco en el Khlong Lat Phrao, 10-15 baht por tazón.",
      ]},
      { type: "callout", emoji: "⚠️", text: "La estafa del tuk-tuk: si un conductor te ofrece llevarte a ver templos 'cerrados' y llevarte a una tienda de 'descuentos especiales' — es una trampa clásica de comisión. Los templos de Bangkok no cierran al mediodía." },
      { type: "cta", destination: "bangkok", city: "Bangkok", country: "Tailandia", text: "Generá tu itinerario personalizado para Bangkok →" },
    ],
  },
  {
    slug: "marrakech-medina-guia-2026",
    title: "Marrakech: cómo perderse en la Medina sin perderse realmente",
    excerpt: "La Medina de Marrakech es el laberinto más fascinante de África. Callejones sin salida, especias que flotan en el aire y la llamada a la oración al amanecer. Esta guía te enseña a navegarla.",
    category: "guias",
    categoryLabel: "Guías de viaje",
    readTime: 6,
    publishDate: "2026-01-28",
    tags: ["Marrakech", "Marruecos", "Medina", "Jemaa el-Fna", "viaje África"],
    heroEmoji: "🕌",
    metaTitle: "Marrakech 2026: guía completa de la Medina, souks y palacios",
    metaDescription: "Guía de viaje a Marrakech: navegar la Medina, los mejores riads, souks auténticos, palacios y la magia de la plaza Jemaa el-Fna al atardecer. Consejos para no perderse.",
    sections: [
      { type: "intro", text: "Marrakech tiene el poder de hacerte sentir que cruzaste un portal hacia otro siglo. La ciudad nueva (Guéliz) es moderna y funcional, pero la razón para ir es la Medina — un laberinto de 1.000 años con más de 100.000 personas viviendo dentro de sus murallas rosadas." },
      { type: "h2", text: "Cuándo ir a Marrakech" },
      { type: "p", text: "Primavera (marzo-mayo) y otoño (septiembre-noviembre) son la temporada ideal: 22-28°C, perfectos para caminar. El verano (junio-agosto) es extremo: 38-42°C al mediodía. El invierno es sorprendentemente frío por las noches (5-10°C). Ramadán cambia completamente la dinámica de la ciudad — restaurantes cerrados de día, vida nocturna intensa." },
      { type: "h2", text: "La Medina: cómo orientarse" },
      { type: "p", text: "La Medina de Marrakech tiene más de 150 km de callejones. El GPS falla constantemente porque las calles cambian de nombre cada 100 metros. La estrategia que funciona: usá la Koutoubia (el minarete más alto de la ciudad) como punto de referencia permanente. Desde cualquier punto de la Medina podés verla." },
      { type: "list", items: [
        "Jemaa el-Fna: la plaza central. De día, naranjeros y encantadores de serpientes. Al atardecer, el mayor espectáculo gastronómico-cultural de África: más de 100 puestos de comida.",
        "Souks por barrio: souk de especias (cerca de la Bou Jaloud), souk de cuero (Chouara Tannery, verla desde las terrazas de las tiendas), souk de lámparas, souk de babuchas.",
        "Mellah (barrio judío): el más tranquilo y fotogénico, con balcones coloridos y la sinagoga Lazama del siglo XVII.",
        "Riad Bellarj: una antigua casa de cigüeñas convertida en espacio cultural. Entrada libre, exposiciones de arte marroquí.",
      ]},
      { type: "h2", text: "Los palacios y jardines imprescindibles" },
      { type: "list", items: [
        "Palacio Bahía (siglo XIX): el más accesible. Entrada 70 MAD (~$7). Sin colas por la mañana temprano.",
        "Palacio El Badi: en ruinas, pero las cigüeñas que anidan en las torres compensan cualquier cosa. Entrada 70 MAD.",
        "Madraza Ben Youssef: la escuela coránica más bella de Marruecos. Entrada 70 MAD. Impresionante en la hora del almuerzo cuando no hay gente.",
        "Jardines Majorelle (de Yves Saint Laurent): azul eléctrico y cactus exóticos. 150 MAD, más 50 MAD el museo Berber. Llená en la tarde — ir antes de las 10am.",
        "Jardín de la Ménara: olivos del siglo XII y el pabellón sagadiana con el Atlas nevado de fondo. Entrada libre.",
      ]},
      { type: "callout", emoji: "🤝", text: "El arte de negociar en los souks: el precio inicial es siempre 3-5 veces el precio real. Empezá ofreciendo el 30% de lo que piden y lleguen a un acuerdo en el medio. Sonreí siempre — la negociación es un ritual social, no un combate. Si el vendedor acepta tu primer precio, ofreciste demasiado." },
      { type: "h2", text: "Dónde comer auténtico" },
      { type: "list", items: [
        "Restaurante Dakhla: escondido en la Medina, sin señal en la puerta. Tajine de pollo con limón encurtido y aceitunas por 60 MAD ($6).",
        "Mercado nocturno de Jemaa el-Fna: los puestos 1-6 son los mejores para harira (sopa de lentejas), merguez a la brasa y cous cous. Evitá los que tienen más turistas.",
        "Café Arabe: rooftop con vistas a la Medina y cocina marroquí-mediterránea. Perfecto para el primer día.",
        "Bakchich Café en Guéliz: para escapar de la intensidad de la Medina y comer en un ambiente más relajado.",
      ]},
      { type: "cta", destination: "marrakech", city: "Marrakech", country: "Marruecos", text: "Creá tu itinerario personalizado para Marrakech →" },
    ],
  },
  {
    slug: "amsterdam-canales-guia-2026",
    title: "Ámsterdam más allá de los tulipanes: la guía para viajeros que ya fueron a Europa",
    excerpt: "Ámsterdam es mucho más que canales y cafeterías. Para quienes ya conocen París y Roma, esta ciudad ofrece una experiencia cultural completamente distinta al resto de Europa.",
    category: "guias",
    categoryLabel: "Guías de viaje",
    readTime: 6,
    publishDate: "2026-02-10",
    tags: ["Ámsterdam", "Países Bajos", "Holanda", "museos Ámsterdam", "canales"],
    heroEmoji: "🌷",
    metaTitle: "Ámsterdam 2026: guía de viaje completa — museos, canales y barrios auténticos",
    metaDescription: "Guía de viaje a Ámsterdam: el Rijksmuseum y Van Gogh Museum, los mejores barrios, cómo moverse en bicicleta y dónde comer más allá de los spots turísticos.",
    sections: [
      { type: "intro", text: "Ámsterdam tiene 165 canales, 1.281 puentes y más bicicletas que habitantes. La ciudad más igualitaria y tolerante de Europa tiene también algunos de los mejores museos del mundo. Pero si tu plan es solo el Rijksmuseum, los cafeterías del centro y un paseo en barco, te estás perdiendo lo mejor." },
      { type: "h2", text: "Cuándo ir a Ámsterdam" },
      { type: "p", text: "Primavera (abril-mayo) es el pico máximo — los tulipanes del Keukenhof y el clima ideal lo convierten en la época más concurrida y más cara. El verano (junio-agosto) tiene los días más largos (amanece a las 5:30am). Otoño e invierno son perfectos para museos sin colas y precios más bajos, aunque llueve frecuentemente." },
      { type: "h2", text: "Los museos que valen cada euro" },
      { type: "list", items: [
        "Rijksmuseum: la Ronda de Noche de Rembrandt y La Lechera de Vermeer. Entrada €22.50. Reservá online con días de anticipación — las colas sin reserva llegan a 2 horas.",
        "Van Gogh Museum: la colección más grande de obras de Van Gogh del mundo, 200 pinturas. Entrada €25. Solo con reserva online.",
        "Anne Frank Huis: la casa donde se escondió Ana Frank durante la ocupación nazi. Entrada €16. Reserva obligatoria con meses de anticipación — no hay walk-in.",
        "Stedelijk Museum: arte moderno y diseño del siglo XX-XXI. Infravalorado por los turistas, frecuentado por los locales.",
        "FOAM (Photography Museum): el mejor museo de fotografía de Europa en temporadas de exposición fuerte. Entrada €16.",
      ]},
      { type: "h2", text: "Los barrios que no están en la guía de Lonely Planet" },
      { type: "list", items: [
        "De Pijp: el barrio más multicultural. El Mercado Albert Cuyp (el más grande de Holanda, gratis) y el mejor brunch de la ciudad.",
        "Noord (Amsterdam Norte): cruzá el río IJ en el ferry gratuito desde Central Station. Cero turistas, arte urbano, la fábrica NDSM y la mejor cerveza artesanal de la ciudad.",
        "Jordaan: el barrio de los canales más fotogénico. Perfecto para caminar sin mapa un domingo por la mañana con el mercado de antigüedades Noordermarkt.",
        "Westerpark: el parque con la antigua fábrica de gas convertida en espacio cultural. Restaurantes, cine y mercados de diseño los fines de semana.",
      ]},
      { type: "h2", text: "Cómo moverse: la bicicleta como medio de transporte real" },
      { type: "p", text: "Ámsterdam está diseñada para bicicletas, no para peatones ni autos. Alquilar una bici por €10-15 por día es la forma más eficiente y auténtica de moverse. Reglas básicas: respetá los carriles de bicicleta (prioridad absoluta), usá la campanilla antes de adelantar y no pares en medio del carril. Las bicicletas eléctricas son ideales para quien no pedalea seguido." },
      { type: "callout", emoji: "💡", text: "La I Amsterdam City Card (€75/24hs, €105/48hs, €125/72hs) incluye transporte público ilimitado, entrada a más de 70 museos y un paseo en barco por los canales. Se paga a sí misma en el primer día si hacés 2-3 museos." },
      { type: "h2", text: "Gastronomía: más allá del stroopwafel" },
      { type: "list", items: [
        "Mercado Albert Cuyp (De Pijp): para desayunar haring (arenque crudo) como los holandeses — $3 el pan con haring.",
        "Café Brauer en Jordaan: almuerzo local, sin precio turístico, con vista al canal.",
        "Foodhallen en Oud-West: el mejor mercado gastronómico de la ciudad. 20 cocinas en un hangar de tranvías del siglo XIX.",
        "Vlaams Friteshuis Vleminckx: las papas fritas más famosas de Ámsterdam, desde 1957. Cola garantizada, vale la pena.",
      ]},
      { type: "cta", destination: "amsterdam", city: "Ámsterdam", country: "Países Bajos", text: "Generá tu itinerario personalizado para Ámsterdam →" },
    ],
  },
];
