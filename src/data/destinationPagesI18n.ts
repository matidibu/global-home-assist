...
export const destinationPagesI18n: Partial<Record<string, Partial<Record<DestLang, DestinationI18nEntry>>>> = {
  ...
  dubai: {
    ...
    pt: {
      ...
      heroTitle: "4 dias em Dubai: do Burj Khalifa ao deserto",
      heroSubtitle: "Burj Khalifa, Dubai Mall, safari nas dunas e os souks históricos — o roteiro que combina o futuro e a tradição árabe.",
      bestMonths: "outubro a abril",
      budget: "$200-400 USD/dia",
      travelTips: [
        "O táxi e o metro (Dubai Metro) são as formas mais práticas de te deslocares — o metro chega à maioria dos destinos turísticos",
        "Vestuário modesto nos souks, mesquitas e locais públicos — os ombros e joelhos devem estar cobertos no Deira histórico",
        "O álcool só é servido em hotéis e restaurantes com licença — é totalmente proibido em espaços públicos",
        "O calor é extremo de maio a setembro (45°C+) — planeia atividades em espaços com ar condicionado nessas datas",
        "A moeda local é o Dirham (AED) — praticamente tudo aceita cartão, mas o dinheiro vivo é útil nos souks históricos",
      ],
      days: [
        {
          theme: "Dubai moderna: o Burj e Downtown",
          activities: [
            { name: "Dubai Mall e o Aquário", description: "O centro comercial maior do mundo com 1.200 lojas, um aquário de 10 milhões de litros e uma pista de gelo olímpica. É o espaço de lazer mais visitado do planeta com 100 milhões de visitas anuais.", price: "Grátis (entrar) / AED 130 (aquário)", tip: "O aquário tem o painel de vidro maior do mundo — pode ver-se a partir do exterior do mall sem pagar. O interior vale a pena se tiveres tempo." },
            { name: "Burj Khalifa — At the Top", description: "O edifício mais alto do mundo com 828 metros. A plataforma de observação 'At The Top' no piso 124 oferece vistas a mais de 80 km de distância em dias limpos.", price: "AED 149 (piso 124) / AED 499 (piso 148)", tip: "Reserva online e escolhe o turno das 11h30 para veres Dubai de dia. O pôr do sol é muito procurado e custa mais. O piso 124 tem as melhores fotos." },
            { name: "Fontes de Dubai e almoço", description: "O sistema de fontes maior do mundo em frente ao Burj Khalifa. Os espetáculos noturnos são os mais espetaculares, mas mesmo de dia a escala é impressionante. A área tem dezenas de restaurantes com vistas.", price: "Grátis (fontes) / AED 60-150 (restaurantes)", tip: "O espetáculo de fontes noturno começa às 18h e repete-se a cada 30 minutos. O melhor ângulo é a partir do passeio do lago do Dubai Mall." },
            { name: "Espetáculo de fontes noturno e jantar em Downtown", description: "O espetáculo de fontes noturno sincronizado com música árabe e clássica é uma das experiências mais emotivas de Dubai. Os restaurantes do Dubai Fountain Boardwalk têm as melhores mesas.", price: "Grátis", tip: "Reserva jantar no Zuma ou no Pierchic com vista para o Burj para a primeira noite — a experiência é impactante mesmo que o preço seja alto." },
          ],
        },
        {
          theme: "Dubai clássica: Creek, souks e o bairro histórico",
          activities: [
            { name: "Al Fahidi Historical Neighbourhood", description: "O bairro histórico de Dubai do século XIX, com casas de coral e barro, torres de vento (barjeel) para a ventilação natural e o Dubai Museum. O contraste com os arranha-céus ao fundo é único.", price: "Dubai Museum AED 3", tip: "O museu de Dubai é o mais barato da cidade e um dos mais informativos — 3 AED para ver a história de uma aldeia de pescadores que se tornou megacidade." },
            { name: "Abra pelo Dubai Creek", description: "Os abras são os barcos de madeira tradicionais que atravessam o creek há séculos. A viagem de 5 minutos de Deira a Bur Dubai custa 1 AED e é o transporte mais autêntico e fotogénico da cidade.", price: "AED 1", tip: "Apanha o abra de madeira clássico (não o moderno a motor) — saem do cais de Al Seef. A viagem pelo creek com os dhows de madeira ao fundo é maravilhosa." },
            { name: "Souk do Ouro e Souk das Especiarias", description: "O Gold Souk tem mais de 300 joalherias com 10 toneladas de ouro em exposição. O Spice Souk ao lado tem açafrão iraniano, incenso árabe, ras el hanout e especiarias do mundo inteiro.", price: "Grátis (compras à parte)", tip: "O regateio é esperado e habitual nos souks. Oferece 60% do preço inicial e vais chegar a um ponto intermédio razoável. O ouro vende-se ao preço de mercado, sem regateio." },
            { name: "Jantar num dhow pelo Creek", description: "Os dhows tradicionais de madeira transformados em restaurantes flutuantes oferecem jantar buffet enquanto navegam pelo Creek iluminado. A vista dos arranha-céus e das mesquitas a partir da água é espetacular.", price: "AED 120-200", tip: "Há dezenas de dhow cruises — o preço padrão inclui jantar buffet. Reserva no cais de Al Seef à tarde para o turno das 20h30." },
          ],
        },
        {
          theme: "Safari no deserto: dunas, camelos e estrelas",
          activities: [
            { name: "Recolha para Safari no Deserto", description: "Os safaris no deserto de Dubai partem em direção às dunas de Al Lahbab em 4x4. O dune bashing (descida por dunas em 4x4) é a atividade mais adrenalínica da experiência.", price: "AED 200-300 (tour completo)", tip: "Escolhe um tour com empresa de reputação como a Arabian Adventures ou a Orient Tours. Os preços muito baratos costumam ter qualidade mais baixa no jantar e nos espetáculos." },
            { name: "Dune Bashing e pôr do sol nas dunas", description: "A descida a alta velocidade por dunas de 100 metros de altura em 4x4 Land Cruiser. O pôr do sol a partir do topo das dunas de Al Lahbab, com o deserto a estender-se até ao horizonte, é irreal.", price: "Incluído no tour", tip: "Se és propenso a enjoos, toma dramamina antes. Os condutores são profissionais com anos de experiência — deixa que escolham o nível de dificuldade." },
            { name: "Acampamento beduíno: camelos e tatuagem de hena", description: "O acampamento no deserto inclui passeio de camelo, tatuagem de hena, dança do ventre e tiro com arco. O jantar buffet com comida árabe (kharouf, mezze, shisha) sob as estrelas do deserto.", price: "Incluído no tour", tip: "O passeio de camelo dura apenas 5-10 minutos mas a foto vale para toda a vida. Pede ao guia que te tire a foto de baixo para que o dromedário apareça inteiro." },
            { name: "Espetáculo de dança do ventre e Tanoura", description: "A dança Tanoura (bailarino sufi a rodopiar com saias coloridas) e a dança do ventre são os espetáculos incluídos no jantar do acampamento. O espetáculo sob o céu estrelado do deserto é inesquecível.", price: "Incluído no tour", tip: "As estrelas no deserto árabe são espetaculares — leva uma app de astronomia para identificar constelações a partir da escuridão total do acampamento." },
          ],
        },
        {
          theme: "Palm Jumeirah e a Dubai moderna",
          activities: [
            { name: "Atlantis The Palm — Aquaventure", description: "O parque aquático do hotel Atlantis na Palm Jumeirah, com 16 hectares de toboggans, ondas artificiais e a zona de raias e tubarões. Uma das experiências mais adrenalínicas de Dubai.", price: "AED 395", tip: "Reserva online com desconto antecipado. O toboggan 'Tower of Neptune' (queda livre de 27 metros) é o mais extremo. Chega às 9h30 antes das filas." },
            { name: "The Pointe e vistas para o Atlantis", description: "O passeio de restaurantes e lojas na ponta da Palm com a melhor vista do Atlantis a partir da água. As fontes do Pointe fazem um espetáculo noturno gratuito.", price: "Grátis", tip: "O passeio do The Pointe tem vistas diretas para a silhueta do Atlantis com o fundo do Burj Al Arab — a foto da Palm a partir deste ponto é espetacular." },
            { name: "JBR Beach e The Beach", description: "Jumeirah Beach Residence (JBR) é o passeio marítimo mais animado de Dubai, com a praia pública mais concorrida da cidade, restaurantes junto à água e o complexo The Beach com vistas para o Burj Al Arab.", price: "Grátis", tip: "A praia de JBR é pública e gratuita — os balneários e guarda-sóis pagos estão disponíveis mas não são necessários." },
            { name: "Jantar de despedida com vista para o Burj Al Arab", description: "O hotel mais icónico de Dubai (e do mundo) tem forma de vela de dhow. Embora hospedar-se custe milhares de dólares, a partir do restaurante Pierchic ou dos restaurantes da praia de Jumeirah vê-se perfeitamente.", price: "AED 100-300 (restaurantes externos)", tip: "O melhor ângulo do Burj Al Arab é a partir da praia de Umm Suqeim Beach — 200 metros de areia pública em frente ao hotel, perfeita para a foto." },
          ],
        },
      ],
    },
  ...
  londres: {
    ...
    pt: {
      city: "Londres",
      country: "Reino Unido",
      heroTitle: "4 dias em Londres: o roteiro para não perder nada essencial",
      heroSubtitle: "Tower Bridge, British Museum, Notting Hill e o West End — com os museus gratuitos e os pubs que os locais escolhem.",
      bestMonths: "maio a setembro",
      budget: "£120-200/dia",
      travelTips: [
        "O Oyster Card ou cartão contactless é indispensável — o metro em dinheiro custa o dobro do que com cartão",
        "Quase todos os museus mais importantes são gratuitos: British Museum, National Gallery, Tate Modern, V&A, Natural History Museum",
        "A gorjeta não está incluída na maioria dos restaurantes — 10-12% é o habitual se o serviço foi bom",
        "A City fecha quase totalmente aos fins de semana — planeia a zona financeira para dias úteis",
        "Descarrega a app do TfL (Transport for London) para planeares trajetos de metro, autocarro e DLR em tempo real",
      ],
      days: [
        {
          theme: "A Londres histórica: Tower Bridge e a City",
          activities: [
            { name: "Tower of London", description: "Fortaleza milenar fundada por Guilherme, o Conquistador, em 1078. Aqui guardam-se as Joias da Coroa britânica, incluindo a Coroa Imperial com 2.868 diamantes. Os famosos Beefeaters são os únicos guias oficiais.", price: "£34", tip: "Chega quando abre para veres as Joias da Coroa sem multidões. Os Beefeaters dão tours gratuitos incluídos com a entrada — valem muito a pena." },
            { name: "Tower Bridge", description: "A ponte mais famosa de Londres, inaugurada em 1894. A exposição do interior mostra a maquinaria vitoriana que levanta a ponte. O passeio pela passarela de vidro a 42 metros sobre o Tamisa é impressionante.", price: "£14", tip: "A ponte levanta-se várias vezes por dia para deixar passar navios grandes — consulta o calendário no site para a veres." },
            { name: "Borough Market", description: "O mercado gastronómico mais famoso de Londres, aberto desde o século XIII. Mais de 100 bancas de produtores artesanais, queijos, carnes, street food do mundo inteiro e a melhor seleção de comida pronta a comer do centro.", price: "£8-15 (almoço)", tip: "Quinta, sexta e sábado é quando está em pleno funcionamento. O pulled pork do Roast e os chocolates da Rabot 1745 são imperdíveis." },
            { name: "Tate Modern", description: "O museu de arte contemporânea instalado numa central elétrica do século XX, com obras de Picasso, Warhol e Dalí. A vista da Ponte do Milénio e de St Paul's a partir da sala 10 do piso 4 é gratuita e espetacular.", price: "Grátis (exposições temporárias £20)", tip: "O café do piso 6 tem o melhor terraço com vistas para o Tamisa e a catedral. Perfeito para um chá das 4." },
          ],
        },
        {
          theme: "A Londres imperial: British Museum e Bloomsbury",
          activities: [
            { name: "British Museum", description: "O museu mais visitado do Reino Unido alberga 8 milhões de objetos: a Pedra de Roseta, as esculturas do Partenon, as múmias egípcias e o tesouro de Sutton Hoo. Impossível ver tudo num dia.", price: "Grátis", tip: "Chega às 9h (uma hora antes de abrir ao público geral com entrada online) para veres a Pedra de Roseta sem a multidão. O Grande Pátio é impressionante." },
            { name: "Covent Garden", description: "A antiga praça de mercado transformada em destino de compras, gastronomia e entretenimento. Artistas de rua, restaurantes e o Mercado de Covent Garden com as suas pontes vitorianas de ferro.", price: "Grátis (compras e comida à parte)", tip: "Os artistas de rua da Piazza têm de passar uma audição municipal — o nível é muito alto. A atuação das 12h30 costuma ser a melhor do dia." },
            { name: "National Gallery", description: "A coleção de pintura europeia mais importante da Grã-Bretanha em Trafalgar Square. Van Eyck, Leonardo, Rembrandt, Monet e Turner fazem parte das 2.300 obras do museu.", price: "Grátis", tip: "A Sala 30 com os impressionistas franceses (Monet, Renoir, Seurat) é a favorita dos locais. A selfie em frente aos leões de Trafalgar Square é obrigatória." },
            { name: "Espetáculo no West End", description: "O distrito teatral de Londres tem mais de 50 teatros ativos, com os melhores musicais e peças do mundo. Les Misérables, Mamma Mia e O Fantasma da Ópera estão em cartaz há décadas.", price: "£30-100", tip: "Os bilhetes do dia (day seats) ou de última hora (standby) vendem-se de manhã nas bilheteiras. Podes conseguir bons lugares a metade do preço." },
          ],
        },
        {
          theme: "Notting Hill, Hyde Park e Kensington",
          activities: [
            { name: "Portobello Road Market", description: "O mercado mais famoso de Londres, ativo desde 1837, com antiguidades aos sábados e fruta e flores toda a semana. As casas coloridas do bairro de Notting Hill são o fundo perfeito.", price: "Grátis (compras à parte)", tip: "O sábado é o dia grande com até 1.000 bancas de antiguidades. Chega antes das 10h para veres os melhores objetos antes de serem comprados." },
            { name: "Hyde Park e Kensington Gardens", description: "Os dois parques reais ligados formam um dos pulmões verdes maiores de Londres. O Serpentine Lake, o Speaker's Corner e o monumento a Lady Di são os pontos mais visitados.", price: "Grátis", tip: "Aluga uma cadeira dobrável junto ao Serpentine e observa os londrinos a passar. É grátis sentares-te na relva — as cadeiras são pagas (£2)." },
            { name: "Victoria & Albert Museum", description: "O museu de design e artes decorativas maior do mundo, com coleções de moda, cerâmica, joalharia, fotografia e mobiliário de 5.000 anos de história humana.", price: "Grátis", tip: "O pátio interior com o café e o jardim é um dos segredos mais bem guardados do museu. Perfeito para a pausa de almoço dos londrinos." },
            { name: "Harrods e Knightsbridge", description: "O grande armazém mais famoso do mundo no coração de Knightsbridge. Mesmo que não compres nada, os corredores de alimentos gourmet, perfumaria e a galeria de moda são um espetáculo visual.", price: "Grátis (entrar)", tip: "O food hall da cave do Harrods é um dos melhores do mundo. Podes comprar um bolo ou chá para levar por £5-10 e experimentá-lo sem gastar uma fortuna." },
          ],
        },
        {
          theme: "Greenwich, o Tamisa e despedida",
          activities: [
            { name: "Palácio de Buckingham e Changing of the Guard", description: "A residência oficial da família real britânica. A troca da guarda acontece às 11h e dura 45 minutos — um ritual com música da Banda do Exército que vale a pena ver pelo menos uma vez.", price: "Grátis (exterior) / £35 (interior no verão)", tip: "Para veres bem a troca da guarda, chega às 10h30 e posiciona-te em frente ao portão central. Os grupos chegam tarde e não veem nada." },
            { name: "St James's Park", description: "O parque real mais antigo de Londres, com vistas diretas para o palácio, os famosos pelicanos do lago e a ponte pedonal com a vista mais fotogénica de Londres em direção a Buckingham.", price: "Grátis", tip: "Os pelicanos do parque são descendentes da oferta do czar russo em 1664. São alimentados às 14h30 todos os dias junto ao lago — é um espetáculo." },
            { name: "Greenwich: Meridiano e Observatório", description: "O bairro de Greenwich alberga o Meridiano de Greenwich (longitude 0°), o Observatório Real e o Cutty Sark, o clipper de chá mais famoso da história. Uma viagem pelo Tamisa de ferry até aqui faz parte da experiência.", price: "Ferry £6 / Observatório £18", tip: "Podes atravessar o Meridiano com um pé em cada hemisfério gratuitamente — a linha verde está marcada no chão exterior do Observatório." },
            { name: "Pub tradicional em Soho", description: "Os pubs de Soho são o coração social de Londres. The Lamb and Flag (fundado em 1623), The Nellie Dean e o French House têm a atmosfera e a história que as cadeias não conseguem imitar.", price: "£6-8 por pinta", tip: "Em Londres pede-se ao balcão — não esperes que venham servir à mesa. Uma pinta de Guinness ou uma bitter local são as bebidas mais típicas." },
          ],
        },
      ],
    },
  ...
  "nueva-york": {
    ...
    pt: {
      city: "Nova Iorque",
      country: "Estados Unidos",
      heroTitle: "5 dias em Nova Iorque: o roteiro para a primeira vez perfeita",
      heroSubtitle: "Brooklyn Bridge, Central Park, MoMA e Harlem — sem perder tempo com o que não vale a pena.",
      bestMonths: "setembro a novembro e abril a junho",
      budget: "150-280 USD/dia",
      travelTips: [
        "Carrega o MetroCard ou usa o OMNY (cartão contactless) — 2,90 USD por viagem, independentemente da distância",
        "O metro funciona 24 horas por dia, mas é lento à noite e ao fim de semana há desvios frequentes",
        "Deixa sempre 18-22% de gorjeta nos restaurantes — é socialmente obrigatório e faz parte do salário",
        "O CityPASS poupa 40% se visitares 4+ atrações pagas em 9 dias consecutivos",
        "Descarrega a app NYC Ferry — o ferry do East River é transporte público barato com vistas espetaculares",
      ],
      days: [
        {
          theme: "Manhattan central: Times Square, Central Park e o Met",
          activities: [
            { name: "Central Park ao nascer do sol", description: "840 acres de parque no coração de Manhattan. A Bethesda Fountain, a Bow Bridge e as vistas do skyline a partir do Great Lawn são os pontos mais fotogénicos.", price: "Grátis", tip: "Aluga uma bicicleta no parque para percorrer mais distância. Aos domingos o circuito exterior fecha aos automóveis." },
            { name: "Museu Metropolitano de Arte (The Met)", description: "O maior museu da América do Norte com mais de 2 milhões de objetos. As coleções egípcia, grega e de armaduras medievais são imperdíveis mesmo que só tenhas 2 horas.", price: "30 USD (sugerido — preço livre para residentes de NY)", tip: "O terraço do Met abre entre maio e outubro com vistas espetaculares para o Central Park. É separado do museu, mas está incluído no bilhete." },
            { name: "Upper West Side e Columbus Circle", description: "O bairro residencial mais tipicamente nova-iorquino de Manhattan, com brownstones, cafés independentes e o mercado gourmet do Time Warner Center.", price: "15-25 USD (almoço)", tip: "O Gray's Papaya na Broadway serve os hot dogs mais icónicos de Nova Iorque a qualquer hora. É assim que os nova-iorquinos tomam o pequeno-almoço desde 1973." },
            { name: "Times Square", description: "O cruzamento mais famoso do mundo, com 26.000 m² de ecrãs LED. Avassalador de dia, mágico ao anoitecer quando as luzes superam o sol.", price: "Grátis", tip: "Se puderes evitar, não comas nem compres nada em Times Square — tudo custa o dobro. Usa-o só para as fotos e segue caminho." },
          ],
        },
        {
          theme: "Brooklyn: a ponte, DUMBO e Williamsburg",
          activities: [
            { name: "Brooklyn Bridge ao nascer do sol", description: "Atravessar a ponte a pé de Manhattan até Brooklyn demora 30 minutos. As vistas do skyline ao nascer do sol, com o East River por baixo, são as melhores fotos de Nova Iorque.", price: "Grátis", tip: "Sai da estação Chambers St em Manhattan. A ponte enche-se de ciclistas rápidos — fica na faixa de peões." },
            { name: "DUMBO — Down Under the Manhattan Bridge Overpass", description: "O bairro com a foto mais famosa de Nova Iorque: o cruzamento da Washington St com o Empire State ao fundo e a ponte de Manhattan a emoldurar a cena.", price: "Grátis", tip: "A foto clássica é na Washington St a olhar para a ponte de Manhattan. Às 9h há pouca gente — ao meio-dia há dezenas à espera da vez." },
            { name: "Brooklyn Heights Promenade", description: "O passeio elevado sobre a FDR Drive com a melhor vista do skyline de Lower Manhattan a partir de Brooklyn. Os locais vêm aqui aos fins de semana com café.", price: "Grátis", tip: "Continua a caminhar até ao Brooklyn Bridge Park, onde podes sentar-te na relva em frente ao skyline." },
            { name: "Williamsburg: brunch e cultura", description: "O bairro hipster de Brooklyn com os melhores brunchs de Nova Iorque, murais de rua, lojas vintage e a margem do East River com vista para Midtown Manhattan.", price: "20-35 USD", tip: "O Smorgasburg em Williamsburg (domingos, abril a outubro) é o melhor mercado de comida de rua de Nova Iorque — 100 vendedores locais." },
          ],
        },
        {
          theme: "Lower Manhattan: história, Ground Zero e a Estátua",
          activities: [
            { name: "Memorial e Museu do 11 de Setembro", description: "Os dois espelhos de água onde ficavam as Torres Gémeas, com os nomes das 2.977 vítimas gravados em bronze. Um local de memória obrigatório.", price: "Memorial grátis / Museu 33 USD", tip: "O memorial ao ar livre é sempre acessível e não precisa de bilhete. O museu é emocionalmente perturbador — reserva tempo para o processar." },
            { name: "Ferry para Staten Island", description: "O ferry para Staten Island parte a cada 30 minutos do Whitehall Terminal. Os 25 minutos de travessia oferecem vistas diretas para a Estátua da Liberdade — completamente grátis.", price: "Grátis", tip: "A melhor vista de Lady Liberty é do lado direito do ferry a caminho de Staten Island. Não precisas de desembarcar — podes voltar no seguinte." },
            { name: "Wall Street e o Charging Bull", description: "O centro financeiro do mundo, com a Bolsa de Nova Iorque, a famosa escultura do touro e a Fearless Girl. O contraste entre a arquitetura neoclássica e os arranha-céus é único.", price: "Grátis", tip: "A NYSE não está aberta ao público. O Museu da Reserva Federal de NY (grátis) mostra o maior cofre de ouro do mundo." },
            { name: "One World Observatory", description: "O observatório do edifício mais alto do hemisfério ocidental, a 381 metros. O elevador sobe em 47 segundos com um ecrã imersivo a mostrar a história de Nova Iorque.", price: "46 USD", tip: "Vale mais do que o Empire State (menos cheio, vistas igualmente impressionantes). Compra o bilhete online." },
          ],
        },
        {
          theme: "Arte e design: MoMA, High Line e Chelsea",
          activities: [
            { name: "MoMA — Museum of Modern Art", description: "A coleção de arte do século XX mais importante do mundo: A Noite Estrelada de Van Gogh, Guernica (reprodução), Dalí e Warhol. O próprio edifício é uma obra de design.", price: "30 USD", tip: "Reserva o bilhete online. Às sextas-feiras, das 17h às 21h, a entrada é por donativo voluntário — muito concorrido mas económico." },
            { name: "High Line", description: "A linha de comboio elevada reconvertida em parque urbano sobre Chelsea. 2,3 km de parque linear com arte pública, vistas para o Hudson e os melhores food trucks da cidade.", price: "Grátis", tip: "Começa na Gansevoort St (extremo sul) e termina em Hudson Yards. O miradouro do Vessel é gratuito a partir do chão." },
            { name: "Chelsea Market", description: "O mercado gourmet instalado na antiga fábrica da Oreo no coração de Chelsea. Dezenas de bancas com as melhores opções gastronómicas a preços razoáveis.", price: "15-30 USD", tip: "Os lobster rolls do The Lobster Place são lendários. Chega antes das 15h para conseguires lugar nas mesas." },
            { name: "Empire State Building à noite", description: "O arranha-céus mais icónico de Nova Iorque, iluminado com cores diferentes consoante eventos e festividades. O terraço do piso 86 oferece vistas de 360° sobre a cidade iluminada.", price: "44 USD", tip: "O segundo observatório (piso 86, ao ar livre) vale mais do que o piso 102. Chega 1 hora antes do fecho para evitar a espera." },
          ],
        },
        {
          theme: "Harlem: a cultura que fez Nova Iorque",
          activities: [
            { name: "Domingo de gospel em Harlem", description: "Aos domingos, as igrejas de Harlem celebram cultos de gospel com coros ao vivo de alto nível. A Abyssinian Baptist Church é a mais famosa — emocionante mesmo que não sejas religioso.", price: "Donativo voluntário", tip: "Vai no domingo de manhã. Veste-te de forma formal — é um culto religioso, não um espetáculo turístico. Sê respeitoso." },
            { name: "Gastronomia afro-americana em Harlem", description: "O Sylvia's Restaurant é a instituição culinária de Harlem desde 1962: frango frito, macaroni and cheese e sweet potato pie que são património cultural de Nova Iorque.", price: "20-35 USD", tip: "O Red Rooster de Marcus Samuelsson é a versão moderna da soul food de Harlem, com reserva indispensável." },
            { name: "Apollo Theater", description: "O teatro onde começaram as carreiras de James Brown, Ella Fitzgerald, Billie Holiday e Michael Jackson. A Amateur Night continua ativa às quartas-feiras — o público mais exigente e honesto do mundo.", price: "Fachada grátis / visitas guiadas 18 USD", tip: "Se a tua visita coincidir com a Amateur Night (quarta-feira), compra o bilhete com antecedência. A noite mais autêntica de Nova Iorque." },
            { name: "The Cloisters — arte medieval sobre o Hudson", description: "O ramo medieval do Met, instalado num autêntico claustro europeu reconstruído sobre o Hudson com vista para Nova Jérsia. As tapeçarias do unicórnio são de outro mundo.", price: "30 USD (incluído no bilhete do Met do dia 1)", tip: "Chega ao final do dia quando a luz do pôr do sol entra pelos vitrais medievais. O menos conhecido dos grandes museus de Nova Iorque." },
          ],
        },
      ],
    },
